...
FlippingBook.prototype.create = function(){
	...
	swfobject.embedSWF("/resources/archive/skin1/ebook.swf", this.containerId, this.stageWidth, this.stageHeight, "8.0.0", "/resources/archive/skin1/js/expressInstall.swf", this.settings, {allowScriptAccess: "always", bgcolor:  "#" + this.settings.backgroundColor.toString( 16 ) });
}
