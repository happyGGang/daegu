			...
			if (autoplayButton) {
				autoplayButton.addEventListener("click", () => {
					if (popupSwiper.autoplay.running) {
						...
						updateAutoplayButton("/resources/homepage/dalseongchild/img/common/play.svg", "재생버튼");
					} else {
						popupSwiper.autoplay.start();
						updateAutoplayButton("/resources/homepage/dalseongchild/img/common/stop.svg", "정지버튼");
					}
				});
			} else {
				console.error("🚨 autoplayButton 요소를 찾을 수 없습니다!");
			}
		});
