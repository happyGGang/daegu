...
$(function(){
	...
	if($('div.Gnb.notype').length > 0){ // 예천
		...
		$('div.Gnb ul.gnb-menu li.List ul, div.Gnb div.mask').on('mouseleave focusout', function(e){
	...
	else if(window.location.pathname.match("^/dgportal/"))
	{
	...
	var bannerLength3 = $('div.banner-wrap.type3 ul.banner-roll').length;
	...
	var bannerLength8 = $('div.banner-wrap.type8 ul.banner-roll').length;
	...
	if (bannerLength8 > 0) {
		bannerSlider8 = $('div.banner-wrap.type8 ul.banner-roll').bxSlider({
			slideWidth:160,
			speed:500,
			moveSlides:1,
			maxSlides:6,
	...
	$('div.banner-wrap a.prev').on('click',function(){
	    ...
	    }else if(bannerSlider8 != null ){
	    	bannerSlider8.goToPrevSlide();
	    }
