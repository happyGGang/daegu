		...
		<div class="before">
			...
			<div class="info-box">
				...
				<div class="section2">
					...
					<div class="default-db">
						<span class="tt1">대구광역시 <br class="web-br"/>공공도서관</span> <span class="tc1">도서관선택을 변경을 원할 경우 <strong>"도서관선택"</strong>을 누르시고 지역 도서관선택을 변경하거나, 지도의 지역구를 선택하여 도서관 선택을 변경하십시오.</span>
					</div>
