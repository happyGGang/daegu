							...
							<div class="" style="padding:6px 0 0 0px">
								<c:choose>
									<c:when test="${homepage.context_path eq 'seogulib'}">
										<form:radiobutton path="booktype" value="BOOKANDNONBOOK" class="radiocheck" checked="checked" cssStyle="margin-left:18px;"/><label for="booktype1" class="booktype">통합</label>
										...
										<tbody>
											<tr>
												...
												<td>
													...
													<c:choose>
														<c:when test="${(homepage.context_path eq 'donggu' || homepage.context_path eq 'dgportal' || homepage.context_path eq 'sincheon' || homepage.context_path eq 'donggusm') && i.SHELF_LOC_CODE eq 'CA18'}">
														</c:when>
														<c:otherwise>
															${i.RETURN_PLAN_DATE}
														</c:otherwise>
