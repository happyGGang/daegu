		...
		<div class="bookDetailInfo">
			...
			<tr>
				...
				<td>
					...
					<c:choose>
						<c:when test="${(homepage.context_path eq 'donggu' || homepage.context_path eq 'dgportal' || homepage.context_path eq 'sincheon' || homepage.context_path eq 'donggusm') && detail.SHELF_LOC_CODE eq 'CA18'}">
						</c:when>
						<c:otherwise>
