			...
			<td>
				<c:choose>
					...
					<c:when test="${context_path eq 'dalseolib'}">
						...
						</form:select><!--<span style="color:#ff0000">  * 도원도서관 희망도서 24.10.01. 신청 재개 예정입니다. </span>-->
					</c:when>
					...
					<c:when test="${context_path eq 'seongseo'}">
						...
						</form:select><!--<span style="color:#ff0000">  * 성서도서관 희망도서 24.10.01. 신청 재개 예정입니다. </span>-->
					</c:when>

					<c:when test="${context_path eq 'bolli'}">
						<form:select path="manageCode">
							<form:option value="BX">본리도서관</form:option>
						</form:select><!--<span style="color:#ff0000">  * 본리도서관 희망도서 24.10.01. 오전 중 신청 재개 예정</span>-->
