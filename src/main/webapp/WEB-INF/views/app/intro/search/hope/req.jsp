...
<%--						<span style="color:#ff0000">  *   도원도서관 희망도서 25. 07. 01. 오전 10시 재개 예정 </span>--%>
					</c:when>
					<c:when test="${context_path eq 'kids'}">
						<form:select path="manageCode">
							<form:option value="BV">달서어린이</form:option>
						</form:select><span style="color:#ff0000">  * 달서어린이도서관 희망도서 25.07.01. 신청 재개 예정입니다. </span>
					</c:when>
...
<%--						<span style="color:#ff0000">  * 성서도서관 희망도서 25.06.01. 신청 재개 예정입니다. </span>--%>
					</c:when>
...
<%--						<span style="color:#ff0000">  * 달서가족문화도서관 희망도서 25. 08. 01. 오전 10시 재개 예정</span>--%>
					</c:when>
		...
		<tr>
			<c:choose>
				<c:when test="${homepage.context_path eq 'donggu' or homepage.context_path eq 'bukgs' or homepage.context_path eq 'bukdh' or homepage.context_path eq 'buktj' or homepage.context_path eq 'gw' or homepage.context_path eq 'sincheon' or homepage.context_path eq 'donggusm'}">
