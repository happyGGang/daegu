...
<div id="wrap" class="k-index">
	...
	<div id="container">
		<ul>
			...
			<c:choose>
				<c:when test="${context_path eq 'dssmalllib' || context_path eq 'dalseonglib' || context_path eq 'dalseongsmall' || context_path eq 'yonghak' || context_path eq 'donggusm'|| context_path eq 'beomeo' || context_path eq 'gosan' || context_path eq 'bookforest' || context_path eq 'padong' || context_path eq 'muhaksup' || context_path eq 'mulmangi' || context_path eq 'sawol'}">
