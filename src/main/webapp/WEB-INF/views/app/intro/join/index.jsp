		...
		<tr>
			<td class="yearSelect">
				<div class="yearSelectAlign">
					...
					<div class="joinBtnTxt">
						<div class="joinText1"><c:if test="${context_path ne 'gukbo' and homepage.context_path ne 'yonghak' and homepage.context_path ne 'beomeo' and homepage.context_path ne 'gosan' and homepage.context_path ne 'muhaksup' and homepage.context_path ne 'mulmangi' and homepage.context_path ne 'bookforest' and homepage.context_path ne 'padong' and homepage.context_path ne 'suseongLake' and homepage.context_path ne 'goldbook' and homepage.context_path ne 'sawol'}">만</c:if> 14세 이상</div>
			...
			<td class="yearSelect">
				<div class="yearSelectAlign">
					...
					<div class="joinBtnTxt">
						<div class="joinText1"><c:if test="${context_path ne 'gukbo' and homepage.context_path ne 'yonghak' and homepage.context_path ne 'beomeo' and homepage.context_path ne 'gosan' and homepage.context_path ne 'muhaksup' and homepage.context_path ne 'mulmangi' and homepage.context_path ne 'bookforest' and homepage.context_path ne 'padong' and homepage.context_path ne 'suseongLake' and homepage.context_path ne 'goldbook' and homepage.context_path ne 'sawol'}">만</c:if> 14세 미만</div>
