...
<div class="join-wrap">
	...
	<form:form modelAttribute="newMember" id="memberAgreeForm" action="integration3.do" method="post">
...
<h4>대구광역시 도서관 통합회원 이용약관</h4>
			<div class="Box" style="height:200px">
			  ...
			  2. 사이트 : 대구광역시 공립 도서관에서 운영하는 홈페이지<br />
			  3. 통합회원 : 대구광역시 공립 도서관 회원 가입에 동의하고 본인확인절차를 통해 회원번호 부여 및 회원카드가 발급된 회원으로 자료의 관외대출이 가능한 회원 또는 통합인증을 통해 통합회원으로 자격이 부여된 회원이며 책이음 이용정보제공이용약관에 동의하면 책이음회원으로 자격을 부여 한다.<br />
			  4. 통합인증 : 기존회원이 대구광역시 공립 도서관 사이트가 제공하는 일정한 신청양식을 기입하고 통합회원, 책이음회원으로의 자격을 부여받는 절차를 의미하며 통합인증을 받지 않으면 일부 서비스의 제약을 받을 수 있다.<br />
			  5. 아이디(ID) : 회원 식별과 회원의 서비스 이용을 위하여 이용자가 생성한 영문자 또는 기타 문자로 조합된 부호 이며 생성하지 않을 때에는 일부 서비스의 제약이 있을 수 있다.<br />
			  ...
			  ④ 대구광역시 공립 도서관의 자료대출 및 좌석예약 실적이 2년 이상 없고 계속 사용에 대한 동의를 하지 않은 경우 회원 효력이 상실된다.<br />
			  ⑤ 대구광역시 공립 도서관은 필요한 경우 개별 서비스에 대하여 이용규정을 정할 수 있으며, 본 약관과 서로 상충되는 경우에는 서비스별 이용규정의 내용을 우선하여 적용한다.<br />
			  ...
			  <strong>제5조 (회원 가입 및 탈퇴)</strong><br />
			  ① 이용자는 도서관에서 제공하는 홈페이지 또는 도서관 내의 회원가입PC의 회원가입신청 양식에 개인의 정보 입력 및 정보 제공을 동의한 후 회원가입을 신청할 수 있다.<br>
			  ② 회원 가입과 동시에 공공도서관 책이음 회원으로 가입된다.<br>
			  ③ 도서관 관리자는 제5조에서 정한 사항을 정확히 기재하여 이용신청을 하였을 경우 특별한 사정이 없는 한 서비스 이용신청을 승낙하여야 한다. 단, 다음의 경우 회원 가입을 취소할 수 있다.<br>
			  <span class="siz12">
			  ...
			  ④ 회원이 이용계약을 해지하고자 할 때에는 회원 본인이 직접 사이트를 통해 탈퇴 신청을 하거나, 도서관을 직접 방문하여 본인확인절차를 거친 후 탈퇴 신청을 하여야 한다.<br>
			  ⑤ 회원탈퇴 시 해당 개인정보는 보유기간이 만료되므로 회원과 관련된 모든 정보는 삭제된다.<br>
			  <br>
			  
			  <strong>제6조 (회원 정보 관리)</strong><br />
			  ① 회원은 홈페이지 회원정보관리 및 도서관에 직접 방문하여 정보를 열람하고 수정할 수 있다. 회원은 이용신청 시 기재 한 사항이 변경된 경우에는 수정을 하여야 하며, 수정하지 아니하여 발생하는 문제의 책임은 회원에게 있다.<br>
			  ② 회원 아이디 및 비밀번호의 관리책임은 회원에게 있다. 이를 소홀히 관리하여 발생하는 서비스 이용상의 손해 또는 제3자에 의한 부정 이용 등에 대한 책임은 모두 회원에게 있으며 도서관은 그에 대해 책임지지 않는다.<br>
			  ③ 도서관은 보안 및 아이디 정책, 서비스의 원활한 제공 등과 같은 이유로 회원 아이디 및 비밀번호 변경을 요구할 수 있다.<br>
			  <br>
			  

			  <strong>제7조 (회원 자격 상실 및 회원정보 삭제)</strong><br />
			  ① 회원은 개인정보보호법 제21조 및 동법 시행령 제16조에 의거하여 다음의 경우 회원 자격을 상실하며, 개인정보도 삭제된다.<br />
			  &nbsp;&nbsp;1. 회원의 탈퇴 신청시<br>
			  &nbsp;&nbsp;2. 2년동안 도서관 서비스를 이용하지 않은 경우<br>
			  &nbsp;&nbsp;3. 홈페이지 개인정보 수집 재동의를 하지 않은 경우(2년주기), 단, 도서 대출 등 도서관 서비스를 이용하는 경우 재동의를 한 것으로 간주<br>
			  ② 단, 다음의 경우 탈퇴 신청은 제한되며, 개인정보 또한 삭제되지 않는다.<br>
			  &nbsp;&nbsp;1. 도서관으로 반납할 자료가 있는 경우<br>
			  &nbsp;&nbsp;2. 대출 자료를 분실 혹은 훼손하고 변상하지 않은 경우<br>
			  &nbsp;&nbsp;3. 기타 회원탈퇴 제한이 필요하다고 도서관장이 인정하는 경우<br>
			  <br>

			  <strong>제8조 (개인정보의 보호 및 사용)</strong><br />
			  ① 도서관은 회원정보를『개인정보보호법』에 의해 보호한다.<br />
			  ② 회원의 개인정보는 오직 본인만이 열람/수정/삭제 할 수 있다. 또한 비밀번호 등이 타인에게 노출되지 않도록 철저히 관리해야하며, 본인의 회원 아이디나 비밀번호가 부정하게 사용되었다는 사실을 발견한 경우에는 즉시 도서관에 신고하여야 한다. 신고를 하지 않아 발생하는 모든 책임은 회원 본인에게 있다<br />
			  ③ 도서관은 서비스 제공과 관련해서 수집된 회원의 신상정보를 본인의 승낙 없이 제3자에게 누설, 배포하지 않는다. 다만, 다음과 같은 경우에 법이 허용하는 범위 내에서 회원의 개인정보를 제3자에게 제공할 수 있다.<br />
			  ...
			  <br>
			  제9조 (서비스의 제공)</strong><br />
				① 도서관 관리자는 회원의 이용신청을 승낙한 때부터 서비스를 개시한다. 단, 일부 서비스의 경우에는 지정된 일자부터 서비스를 개시할 수 있다.<br>
				② 온라인 서비스(사이트)는 도서관의 업무상 또는 기술상 특별한 지장이 없는 한 연중무휴, 1일 24시간 운영을 원칙으로 한다. 단, 도서관은 시스템 정기점검, 증설 및 교체를 위해 도서관이 정한 날이나 시간에 서비스를 일시 중단 할 수 있으며, 예정되어 있는 작업으로 인한 서비스 일시 중단은 도서관을 통해 사전에 공지한다.  <br>
				③ 도서관은 긴급한 시스템 점검, 고체, 설비의 장애, 서비스 이용의 폭주, 국가비상사태, 정전 등 부득이한 사유가 발생한 경우 사전 예고없이 일시적으로 서비스의 전부 또는 일부를 중단할 수 있다.<br>
			  ...
			  ② 서비스의 내용, 이용방법, 이용시간에 대하여 변경이 있는 경우에는 변경사유, 변경될 서비스의 내용 및 제공일자 등은 그 변경 전에 서비스 초기화면에 게시하여야 한다.<br>
			  ② 도서관은 정책 및 운영의 필요에 따라 사전공지를 통해 무료로 제공되는 서비스의 일부 또는 전부를 수 정, 중단, 변경할 수 있으며, 이용회원에게는 별도의 보상을 하지 않는다.<br>
			  <br>
			  ...
			  <strong>제13조 (회원의 의무)</strong><br />
				① 회원은 회원가입 신청 또는 회원정보 변경 시 모든 사항을 사실에 근거하여 본인의 정확한 정보로 작성하여야 하며, 허위 또는 타인의 정보를 등록할 경우 이와 관련된 모든 권리를 주장할 수 없다.<br>
				② 회원은 관계 법령, 본 약관의 규정, 이용 안내 및 도서관이 공지한 주의사항, 도서관이 통지하는 사항 등을 준수하여야 하며, 기타 도서관의 업무에 방해가 되는 행위, 도서관의 명예를 손상시키는 행위, 타인에게 피해를 주는 행위를 해서는 안 된다.<br>
				③ 회원은 본인의 회원ID와 비밀번호를 제3자에게 이용하게 해서는 안 되며, 이용계약사항이 변경된 경우에 해당 절차를 거쳐 이를 도서관에 즉시 알려야 한다.<br>
				④ 회원은 도서관의 사전 승낙 없이 서비스를 이용하여 어떠한 영리행위도 할 수 없으며, 그 영리행위의 결과에 대해 도서관은 책임을 지지 않습니다. 또한 회원은 이와 같은 영리행위로 도서관이 손해를 입은 경우, 회원은 도서관에 대해 손해배상 의무를 지며, 도서관은 해당 회원에 대해 서비스 이용제한 및 적법한 절차를 거쳐 손해배상 등을 청구할 수 있다. <br>
