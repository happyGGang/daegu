		...
		<div id="top">
			...
			<div class="nav">
				...
				<ul>
					...
					<c:choose>
						<c:when test="${context_path eq 'dssmalllib' || context_path eq 'dalseonglib' || context_path eq 'dalseongsmall' || context_path eq 'beomeo' || context_path eq 'gosan' || context_path eq 'bookforest' || context_path eq 'padong' || context_path eq 'muhaksup' || context_path eq 'mulmangi' || context_path eq 'sawol'}">
					<li>
