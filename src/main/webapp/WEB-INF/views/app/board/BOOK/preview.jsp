		...
		<div class="sinfo">
			<div class="thumb">
				<c:choose>
					...
					<c:otherwise>
						<img src="/data/board/${param.manage_idx}/${boardFile[0].board_idx}/${boardFile[0].real_file_name}" alt="${board.title}" onError="this.src='/resources/common/img/noimg-gall.png'">
					</c:otherwise>
				</c:choose>
<!-- 				<p class="noImg"> -->
