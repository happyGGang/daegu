...
function addViewCount(manage_idx, board_idx) {
		var ajaxData = {
		...
		$.ajax({
			type: "POST",
			url: 'addBoardCountForNwjSource.do',
			data: ajaxData,
...
<%-- 					<c:if test="${board.delete_yn eq 'Y' or categoryMovae}"> --%>
					...
					<td class="important left title" style="padding-left:${(i.group_depth > 0 ? (i.group_depth-1)*15 : 0)+10}px;">
						...
						<a href="${i.imsi_v_6 }" target="_blank" onClick="addViewCount('${i.manage_idx}', '${i.board_idx}');">
