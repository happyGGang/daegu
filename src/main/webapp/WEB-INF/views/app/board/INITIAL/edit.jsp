...
<div class="wrapper-bbs">
	<table class="bbs-edit">
		<tbody>
			...
			<tr>
				<th>간별</th>
				<td colspan="3"><form:input path="imsi_v_2" cssClass="text" /></td>
			</tr>
			<tr>
				<th>자료실명</th>
				<td colspan="3"><form:input path="imsi_v_3" cssClass="text" /></td>
			</tr>
			<tr>
				<th>청구기호</th>
				<td colspan="3"><form:input path="imsi_v_4" cssClass="text" /></td>
			</tr>
			<tr>
				<th>작성자</th>
				<td>
