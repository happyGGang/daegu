...
<link rel="stylesheet" type="text/css" href="/resources/book/search/css/seniorBook.css">
								...
								<div class="box">
									<div class="item">
										<div class="bif">
											...
											<c:if test="${boardManage.manage_idx eq '195'}">
											<span style="...">111${i.imsi_v_18}</span>
											<p>
												<c:if test="${not empty i.imsi_v_17}"> [${i.imsi_v_17}]</c:if>
												</c:if>
												<c:if test="${i.imsi_v_3 ne null and i.imsi_v_3 ne '' and i.imsi_v_3 ne '0'}">
													<font style="...">저자 : </font>${fn:substring(i.imsi_v_3, 0, 20)}<c:if test="${fn:length(i.imsi_v_3) > 20}">...</c:if><br class="mobileBr"/>
													<span class="webGuideLine" style="color:#dddddd">&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span>
												</c:if>
												<c:if test="${i.imsi_v_4 ne null and i.imsi_v_4 ne '' and i.imsi_v_4 ne '0'}">
													<font style="..."> 출판사 : </font>${fn:substring(i.imsi_v_4, 0, 20)}<c:if test="${fn:length(i.imsi_v_4) > 20}">...</c:if><br class="mobileBr"/>
													<span class="webGuideLine" style="color:#dddddd">&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span>
												</c:if>
												<c:if test="${i.imsi_v_2 ne null and i.imsi_v_2 ne '0'}">
													<font style="...">출판년도 : </font>${i.imsi_v_2}<br class="mobileBr"/>
													<span class="webGuideLine" style="color:#dddddd">&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span>
												</c:if>
												<c:if test="${boardManage.manage_idx ne '195'}">
													<c:if test="${i.imsi_v_6 ne null and i.imsi_v_6 ne '0'}">
														<font style="...">소장자료실 : </font>${i.imsi_v_6}<br class="mobileBr"/>
														<span class="webGuideLine" style="color:#dddddd">&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span>
													</c:if>
													<c:if test="${i.imsi_v_7 ne null and i.imsi_v_7 ne '0'}">
														<font style="...">청구기호 : </font>${i.imsi_v_7}<br class="mobileBr"/>
													</c:if>
												</c:if>
											</p>
										</div>
