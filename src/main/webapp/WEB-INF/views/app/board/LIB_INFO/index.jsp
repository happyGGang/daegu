		...
		<div id="libraryList" class="innerRight">
			...
			<div class="selector">
				<div class="selection01">
					...
					<ul>
						<li class="lib01"><div><span>공공도서관</span><b>${categoryCount['23']}</b></div></li>
						<li class="lib02"><div><span>전문도서관</span><b>${categoryCount['24']}</b></div></li>
						<li class="lib03"><div><span>대학도서관</span><b>${categoryCount['25']}</b></div></li>
						<li class="lib04"><div><span>작은도서관</span><b>${categoryCount['26']}</b></div></li>
						<li class="lib05"><div><span>학교도서관</span><b>${categoryCount['29']}</b></div></li>
						<li class="lib06"><div><span>기타</span><b>${categoryCount['28']}</b></div></li>
					</ul>
