...
<style>
    #authGroupList tr td:last-child, #authGroupList tr th:last-child {
        display: none;
    }
</style>
...
<div id="editDisable" class="disableBox">
    ...
    <ul class="custom-tab">
        <li class="active"><a href="#" keyValue="table1" id="tabLi1" data-tab="D">기본 정보</a></li>
        <li class=""><a href="#" keyValue="table2" id="tabLi2" data-tab="R">그룹관계 설정</a></li>
    </ul>
        ...
        <div class="table-wrap" id="table1" title="기본정보">
            <div class="btn-wrapper left">
                ...
                <c:if test="${memberGroup.member_group_idx > 0 and memberGroup.default_group_yn ne 'Y'}">
                    <a href="" class="icon-btn gray" id="editGroup_modify">수정</a>
                    <a href="" class="icon-btn red" id="editGroup_delete">
                ...
                <table class="custom-table">
                    ...
                    <tbody id="authGroupList">
                        ...
                        <c:forEach var="i" varStatus="status" items="${memberGroupList}" begin="1">
                            <tr data-level="${i.member_group_depth}" data-parentGroupIdx="${i.parent_member_group_idx}" class="table-left">
...
<div id="dialog-1" class="dialog-common" title="권한그룹"></div>