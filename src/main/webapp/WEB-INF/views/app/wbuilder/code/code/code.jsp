...
<div class="disableBox" id="editDisable">
    ...
    <table class="custom-table">
        ...
        <tbody>
        <form:form id="codeIndex" method="POST" modelAttribute="code">
            ...
            <c:forEach items="${codeList}" var="i" varStatus="status">
                <tr>
                    ...
                    <td>
                        <c:if test="${authU}">
                            <a class="custom-btn" href="" id="dialog-modify" keyValue="${i.code_id}">수정</a>
                        </c:if>
                        <c:if test="${authD}">
                            <a class="custom-btn" href="" id="code_delete" keyValue="${i.code_id}">삭제</a>
                        </c:if>
                    </td>
                </tr>
            </c:forEach>
    ...
    <div class="dialog-common" id="dialog-2" title="코드정보"></div>
</div>	