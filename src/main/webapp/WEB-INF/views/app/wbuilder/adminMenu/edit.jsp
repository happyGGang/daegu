        ...
        <table class="menu-detail-table">
            ...
            <tbody>
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <div class="path">
                                    ...
                                    ${parentAdminMenu.menu_full_path_name} <img alt="" src="/resources/cms/img/main/arrow.svg"> <span class="menuName"></span>
                                </div>
                            </c:otherwise>
                        </c:choose>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <div class="custom-checkbox">
                            <input ${(adminMenu.editMode eq id="access_homepage_all" type="checkbox" 'ADD' or
                        ...
                        <c:forEach items="${homepageList}" var="i" varStatus="status">
                            <c:if test="${not empty i.homepage_alias}">
                                <div class="custom-checkbox">
                                    <form:checkbox label="${i.homepage_alias}" path="access_homepage_id_arr" value="${i.homepage_id}"/>
                                </div>
                            </c:if>
                            <c:if test="${empty i.homepage_alias}">
                                <div class="custom-checkbox">
                                    <form:checkbox label="${i.homepage_name}" path="access_homepage_id_arr" value="${i.homepage_id}"/>
                                </div>
                            </c:if>
                ...
                <tr id="menuTypeModule" style="display: none;">
                    <th>모듈선택</th>
                    <td>
                        <form:select cssClass="selectmenu-search" cssStyle="width:98%" itemLabel="module_name" itemValue="module_idx" items="${moduleList}" path="module_idx">
                        </form:select>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <tag:menuAuthCheckbox auth_id_array="${menuAuthArray}" id="auth_${status.index}" name="auth_id_array" value="${i.auth_id}"/>
