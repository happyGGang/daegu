...
<form:form modelAttribute="librarySearch" action="index.do" method="GET">
	...
	<div class="search-wrap">
		...
		<div class="search-wrap" style="border-top:1px solid #ddd;">
									...
									<div class="box">
										<div class="item">
											<div class="bif">
												...
												<p><font style="color:#5e5e5e">발행처</font> : ${i.PUBLISHER}</p>
												...
												<p><font style="color:#5e5e5e">자료실</font> : ${i.SHELF_LOC_NAME}<p>
