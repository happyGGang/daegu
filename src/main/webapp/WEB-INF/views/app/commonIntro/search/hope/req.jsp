...
<form:form id="reqHopeForm" modelAttribute="librarySearch" action="save.do" method="post">
	...
	<table class="edit">
		...
		<tr>
			...
			<td><form:input path="publer_year" style="width:10%" class="text" type="text" numberOnly="true" maxlength="4"  readonly="${homepage.context_path eq 'bukgs' ? 'true' : 'false'}"/></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><form:input path="price" style="width:20%" class="text" type="text" maxlength="10" numberOnly="true"  readonly="${homepage.context_path eq 'bukgs' ? 'true' : 'false'}"/><font color="red"> *정가로 기입해 주세요</font></td>
		</tr>
