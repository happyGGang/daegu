									...
									<div class="item">
										<div class="bif">
											...
											<div class="stat">
												...
												<a href="#showSlide" class="selectBook" keyValue="${i.TITLE_INFO}///${i.PUB_YEAR}///${i.AUTHOR}///${i.PUBLISHER}///${fn:escapeXml(i.ST_CODE)}///${i.CALL_NO}///${imageUrl}///${i.SHELF_LOC_NAME}"><span>선택하기</span></a>
											</div>
										</div>
									</div>
								</div>
