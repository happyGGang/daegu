...
<div class="search-wrap">
	<div class="sview">
		...
		<div class="sbtn" style="text-align:center;">
			...
			<!-- 북구통합도서관 상호대차 설정시작-->
			<c:choose>
				<c:when test="${homepage.context_path eq 'dmsl' || homepage.context_path eq 'bukgs' || homepage.context_path eq 'bukdh' || homepage.context_path eq 'buktj' || homepage.context_path eq 'buksb'}">
					<c:choose>
				...
				<c:when test="${homepage.context_path eq 'seogulib'}">
					...
					<c:choose>
						<c:when test="${detail.MANAGE_CODE eq 'BL' || detail.MANAGE_CODE eq 'BQ' || detail.MANAGE_CODE eq 'BP' || detail.MANAGE_CODE eq 'BM' || detail.MANAGE_CODE eq 'BN' || detail.MANAGE_CODE eq 'CC' || detail.MANAGE_CODE eq 'HT'}">
							<c:choose>
