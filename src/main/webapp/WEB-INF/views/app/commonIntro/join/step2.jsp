  ...
  <div class="join-wrap2 join-wrap" style="padding:18px 0">
    ...
    <c:when test="${homepage.context_path eq 'dotory' || homepage.context_path eq 'dongil' || homepage.context_path eq 'vision' || homepage.context_path eq 'saebut' || homepage.context_path eq 'art' || homepage.context_path eq 'yeonam' || homepage.context_path eq 'daegubl' || homepage.context_path eq 'wasabi' || homepage.context_path eq 'handle'}">
		...
		<div class="Box" style="height:200px">
		  ...
		  제1조 (목적)</strong><br />
		  본 약관은 『대구광역시 도서관 허브시스템』을 구축(이하 ‘시스템’이라 함)에 따라 대구광역시 공립 공공도서관 및 공립 작은도서관(이하 ‘도서관’ 이라 한다.) 회원 정보를 운영함에 있어 이용자와 도서관간의 이용조건 및 절차, 이용에 관한 권리와 의무 등 제반사항을 규정함을 목적으로 한다.<br>
		  <br>
		  ...
		  3. 회원 : 도서관 회원 가입에 동의하고 본인확인절차를 통해 회원번호 부여 및 회원카드가 발급된 회원으로 자료의 관외대출이 가능한 회원이다.<br />
		  4. 아이디(ID) : 회원 식별과 서비스 이용을 위하여 이용자가 생성한 영문자 또는 기타 문자로 조합된 부호<br />
		  5. 비밀번호(PASSWORD) : 회원의 정보 보호를 위해 이용자 자신이 설정한 문자와 숫자, 특수문자 등으로 조합된 부호<br />
		...
		<div class="agree_codes">
		  <input id="agree_codes1" name="agree_codes" req="0001" type="checkbox" value="1"><label for="agree_codes1">회원 이용약관에 동의합니다.</label><input type="hidden" name="_agree_codes" value="on"><br>
		</div>
    </c:when>
    <c:otherwise>
		...
		<div class="Box" style="height:200px">
		  ...
		  <strong>제5조 (회원 자격) 회원은 다음 각 호의 어느 하나에 해당하는 경우 그 자격을 가진다.</strong><br />
		  <span class="siz12">
		  &nbsp;&nbsp;1. 대구광역시(경산시, 칠곡군, 의성군 포함)에 주민등록이 되어 있는 자<br>
		  &nbsp;&nbsp;2. 대구광역시 소재 직장에 재직하는 자<br>
		  &nbsp;&nbsp;3. 대구광역시(경산시, 칠곡군, 의성군 포함)소재 학교에 재학하는 자<br>
		  &nbsp;&nbsp;4. 대구광역시에 거주하는 재외동포 국내거소 신고자 및 외국인 등록자<br>
		  &nbsp;&nbsp;5. 그밖에 관장이 필요하다고 인정하는 자<br>
		  </span><br>
		  <br>
		  ...
		  <div>
			...
			<tr>
			  <td rowspan="3" style="width:10%">필수</td>
			  <td style="width:15%">14세 이상</td>
			  <td style="width:35%">아이디, 비밀번호, 성명, 생년월일, 성별, 휴대폰번호 또는 전화번호(자택), 주소, 도서회원번호, CI값, 도서대출내역, SMS수신여부, 제2연락처</td>
			  <td rowspan="2" style="width:20%">
				도서대출 및
				반납 등
				도서관 서비스
			...
			<tr>
			  <td>14세 미만</td>
			  <td>아이디, 비밀번호, 성명, 생년월일, 성별, 휴대폰번호 또는 전화번호(자택), 주소, 도서회원번호, CI값, 도서대출내역 법정대리인 성명 및 연락처, SMS수신여부, 제2연락처</td>
			</tr>
			<tr>
			  <td colspan="2">법정대리인 성명, 연락처</td>
			  <td>
    ...
    <c:when test="${homepage.context_path eq 'dotory' || homepage.context_path eq 'dongil' || homepage.context_path eq 'vision' || homepage.context_path eq 'saebut' || homepage.context_path eq 'art' || homepage.context_path eq 'yeonam' || homepage.context_path eq 'daegubl' || homepage.context_path eq 'wasabi' || homepage.context_path eq 'handle'}">
		<div class="Box" style="height:200px">
		  ...
		  <tr>
			<td colspan="4">개인정보 제3자 제공에 거부할 권리가 있습니다. 다만 동의를 거부 할 경우 서비스 회원가입이 되지 않으며, 도서관에서 제공하는 서비스 이용에 제한이 있을 수 있습니다.</td>
		  </tr>
		  </tbody>
		  </table>
    ...
    <c:otherwise>
		<div class="Box" style="height:200px">
		  ...
		  <tr>
			<td>대구광역시 공립 도서관</td>
			<td>하나의 회원번호로 대구광역시 모든 공립 도서관 이용</td>
			<td>아이디, 비밀번호, 도서회원번호, 성명, 생년월일, 성별, 휴대폰번호, 주소, CI값, 도서대출내역, 법정대리인 성명 및 연락처, 이메일, 전화번호(자택), 근무처(학교명), 근무지(학교)연락처, 근무지(학교)주소, 제2연락처</td>
			<td>회원<br/>탈퇴시까지</td>
		  </tr>
		  <tr>
