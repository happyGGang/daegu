...
<div class="">
	...
	<!-- <div class="Box" style="height:120px">
		...
		독서교육 종합지원시스템(DLS)에 가입 된 회원은 추가인증을 통해 비대면 회원가입으로 전자도서관을 이용가능 합니다. 아래의 '전환한기' 버튼을 누르면 추가인증 페이지로 이동합니다.<br>
	...
	<div class="btn-wrap" style="text-align:center;padding:20px 0">
		<a href="dls.do?menu_idx=${param.menu_idx}" class="btn btn01" style="background:#0071f1;border:1px solid #1d62af;color:#fff;">전환하기</a>
