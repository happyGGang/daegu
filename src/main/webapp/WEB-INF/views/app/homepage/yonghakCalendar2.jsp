	...
	<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
		<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
			...
			<div class="doc-body">
				...
				<h3>장서현황<span class="sm_text sm_text02" style="margin-top:10px;">[기준 : 2023.10.31.] (단위 : 권)</span></h3>
				...
				<div class="info_box">
					...
					<p class="info_tel">053-668-1760</p>
				...
				<ul class="con">
					...
					<li>캐슬골드파크(1102동)(619m, 도보 10분-휠체어 20분) / 캐슬골드파크(1504동)(498m, 도보 7분-휠체어 14분) : 100, 100-1, 234, 349, 수성3-1,
						순환3, 수성4</li>
					<li>대우트럼프월드수성 앞(846m, 도보 14분-휠체어 28분) / 대우트럼프월드수성 건너(732m, 도보 11분-휠체어 22분) : 수성3, 수성3-1, 204, 814, 수성1, 수성1-1,
						8140</li>
				</ul>
				...
				<ul class="con">
					...
					<li>수성구청입구에서 출발 → 달구벌대로에서 우회전 → 0.68km 직진 후 우회전 → 1.9km 직진 후 우회전 → 1km 직진 후 북성교회에서 유턴 → 0.14km 직진 후 올리브영에서 우회전
						→ 0.35km 직진 후 좌회전</li>
				</ul>
			</div>

			<div style="text-align:center;">
				<div class="link_btn02" style="display:inline-block;"> <a
						href="https://library.daegu.go.kr/yonghak/board/index.do?menu_idx=35&manage_idx=677&board_idx=0&group_idx=0&category1=003&rowCount=10&_boardIdxArray=on&_boardIdxArray=on&_boardIdxArray=on&_boardIdxArray=on&_boardIdxArray=on&_boardIdxArray=on&_boardIdxArray=on&_boardIdxArray=on&_boardIdxArray=on&_boardIdxArray=on&viewPage=1&searchStartDate=2019-12-28&searchEndDate=2020-12-28&search_type=title%2Bcontent">공지사항
						바로가기 </a> </div>
				<div class="link_btn02" style="display:inline-block;"> <a
						href="/yonghak/module/teach/index.do?menu_idx=100&searchCate1=30&homepage_id=h51">문화강좌 바로가기</a> </div>
			</div>
			</div>