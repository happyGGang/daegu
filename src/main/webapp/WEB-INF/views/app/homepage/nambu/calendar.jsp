...
<div id="calendar2">
	<div class="calendar-controller">
		<a id="before-btn" href="#prev" keyValue="${calendar.plan_date}">
			<img src="/resources/homepage/nambu/img/culture/calendar-left-arrow.svg" alt="">
		</a>
		...
		<a id="next-btn" href="#next" keyValue="${calendar.plan_date}">
			<img src="/resources/homepage/nambu/img/culture/calendar-right-arrow.svg" alt="">
		</a>
	</div>
	<table>
		<thead>
				...
				<div id="${i.key}" class="calAll">
					<div class="calendar-header">
						...
						<a href="#" class="close closePlanView">
							<img src="/resources/homepage/nambu/img/culture/calendar-popup-close.svg" alt="">
						</a>
					</div>
