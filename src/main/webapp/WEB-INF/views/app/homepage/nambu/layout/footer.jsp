...
<div class="footer-wrapper footer-top">
    <div class="wrapper">
        <div class="library-info">
            ...
            <div class="library-detail">
                ...
                <div class="library-detail-wrapper">
                    ...
                    <div><span>팩스</span> 053-653-6097</div>
                </div>
            </div>
        </div>
        <div class="sns-wrapper">
            ...
            <div class="sns-list">
                <a class="kakao sns-icon" href="https://pf.kakao.com/_WPCfb"></a>
                <a class="x sns-icon" href="https://x.com/nbl5539"></a>
                <a class="facebook sns-icon" href="https://www.facebook.com/nbl5539/"></a>
            </div>
        </div>
    </div>
</div>
<div class="footer-wrapper footer-bottom">
    <div class="wrapper">
        <div class="copyright">Copyright © 2020 DAEGU METROPOLITAN NAMBU LIBRARY</div>
