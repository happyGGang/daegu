...
<div class="holiday-area-controller">
    <a href="#" id="before-btns" role="button" keyValue="${calendar.plan_date}">
        <img src="/resources/homepage/dongbu/img/main/holiday-left-arrow.svg" alt="지난달"/>
    </a>
    <div>
    ...
    <a href="#" id="next-btns" role="button" keyValue="${calendar.plan_date}">
        <img src="/resources/homepage/dongbu/img/main/holiday-right-arrow.svg" alt="다음달"/>
    </a>
</div>
...
<div class="holiday-list">
    <c:choose>
        ...
        <c:otherwise>
            <c:forEach items="${dd}" var="day" end="18">
                <div>${day}</div>
            </c:forEach>
            <c:if test="${fn:length(dd) > 19}">
                <a href="https://library.daegu.go.kr/dongbu/module/calendarManage/index.do?menu_idx=63" class="go-to-holiday">
                    <img src="/resources/homepage/dongbu/img/main/go-to-holiday.svg" alt="">
                </a>
            </c:if>
        </c:otherwise>
    </c:choose>
