				...
				<div class="main4 tabS">
					...
					<div class="box con" data-tab="tab3" style="display:none;">
						<ul class="lt_photo bookQuration">
							...
							<li>
								<a class="goDetail" href="/${homepage.context_path}/board/index.do?menu_idx=130&manage_idx=${curation1.manage_idx}">
									<c:choose>
							...
							<li>
								<a class="goDetail" href="/${homepage.context_path}/board/index.do?menu_idx=131&manage_idx=${curation2.manage_idx}">
									<c:choose>
