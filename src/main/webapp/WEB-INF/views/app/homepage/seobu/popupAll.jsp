...
<c:if test="${fn:length(popupFullList) > 0}">
    <div class="total-popup-controller">
        <div class="total-popup-controller-btn popup-today-close">
            <div>오늘 하루 열지 않기</div>
            <img src="/resources/homepage/seobu/img/common/total-popup-close.svg" alt="">
        </div>
    ...
    <div class="total-popup-content">
        ...
        <div class="total-popup-slide-wrapper">
            <img class="total-popup-slide-prev" src="/resources/homepage/seobu/img/common/total-popup-left-arrow.svg" alt="">
            ...
            <img class="total-popup-slide-next" src="/resources/homepage/seobu/img/common/total-popup-right-arrow.svg" alt="">
        </div>
    </div>
</c:if>
