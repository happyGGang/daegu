...
<!-- footer_section -->
    <div class="mFooter">
        ...
        <div class="middle">
            <div class="sections">
                <div class="sections bottom_wrap">
                    <div class="address_sections">
                        <p>
                            <span>(42998) 대구 달성군 현풍읍 현풍동로19길 26</span><br class="mobileBr"/>
                            <span>전화 <b> 053-231-2150 </b></span>
                            <span>팩스 <b> 053-615-7975</b></span>
                        </p>
                        <br/>
                        <p class="copyright">Copyright ⓒ 대구달성어린이숲도서관. All rights reserved.</p>
                    </div>
                    <div class="site_link">
                        <div>
                            <div>
                        ...
                        <div>
                            <div>
                                ...
                                <ul style="display: none">
                                    ...
                                    <li class="disabled"><a title="대구평생교육진흥원" href="https://dle.study.daegu.kr/index.do">대구평생교육진흥원</a></li>
                                </ul>
                            </div>
                            <a href="#" class="btn">이동</a>
                        </div>
    ...
    <div class="home-up mobile-view">
        <a href="#firstPage"><img src="/resources/homepage/dalseongchild/img/common/m-top-btn.png" alt="위로" class="homeup" id="homeup"/></a>
    </div>

    <div class="home-up web-view">
        <a href="#firstPage"><img src="/resources/homepage/dalseongchild/img/common/m-top-btn.png" alt="위로" class="homeup" onclick="window.scrollTo(0,0);"/></a>
    </div>
<!-- //footer_section -->
