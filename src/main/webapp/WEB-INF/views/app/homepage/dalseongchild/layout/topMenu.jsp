...
<div class="head">
    <div class="Gnb">
        ...
        <div class="main-section">
            <h1 class="web-logo"><a href="/${homepage.context_path}/index.do">어린이 숲도서관</a></h1>

            <!-- menu S -->
            <div class="g-menu">
                <homepageTag:topMenu menuList="${menuTreeList}"/>

                <a href="/${homepage.context_path}/sitemap/index.do?menu_idx=82" class="last-box_w"><span></span><span></span><span></span></a>
                <div class="mmode">
