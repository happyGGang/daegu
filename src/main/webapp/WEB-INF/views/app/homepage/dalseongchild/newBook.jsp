		...
		<div class="book-slide">
			...
			<c:forEach var="i" begin="0" end="${loopCount - 1}">
				<div class="book-slide-item">
					<a href="/${homepage.context_path}/intro/search/detail.do?menu_idx=9&isbn=${newBookList[listNums[i]].ST_CODE}&regNo=${fn:escapeXml(newBookList[listNums[i]].REG_NO)}&manageCode=${fn:escapeXml(newBookList[listNums[i]].MANAGE_CODE)}&booktype=BO">
						<c:choose>
					...
					<a href="/${homepage.context_path}/intro/search/detail.do?menu_idx=9&isbn=${newBookList[listNums[i]].ST_CODE}&regNo=${fn:escapeXml(newBookList[listNums[i]].REG_NO)}&manageCode=${fn:escapeXml(newBookList[listNums[i]].MANAGE_CODE)}&booktype=BO" class="title">
						<div>${newBookList[listNums[i]].TITLE_INFO}</div>
