...
jQuery(function($){
	...
	daegu_map_data.push({idx:'44',title:'서변숲도서관', tel:'053-320-3800', point:{x:'35.9214334',y:'128.5948453'}, address:'대구광역시 북구 서변로3길 54(서변동)',no:'65' });

	/* 수성구 */
	daegu_map_data.push({idx:'59',title:'대구광역시립수성도서관', tel : '053-231-2551', point:{x:'35.8721329094016',y:'128.63906132752'}, address:'대구광역시 수성구 만촌로 151',no:'66' });
	daegu_map_data.push({idx:'58',title:'범어도서관', tel : '053-668-1600', point:{x:'35.8593751012399',y:'128.630676348493'}, address:'대구광역시 수성구 달구벌대로 2451',no:'67' });
	daegu_map_data.push({idx:'57',title:'용학도서관', tel : '053-668-1700', point:{x:'35.8211298167339',y:'128.644705546516'}, address:'대구광역시 수성구 지범로41길 16',no:'68' });
	daegu_map_data.push({idx:'56',title:'고산도서관', tel : '053-668-1900', point:{x:'35.8379053106723',y:'128.710632720214'}, address:'대구광역시 수성구 달구벌대로650길 6(신매동)',no:'69' });
	daegu_map_data.push({idx:'55',title:'파동도서관', tel : '053-668-1801', point:{x:'35.8104539258976',y:'128.618146184099'}, address:'대구광역시 수성구 파동로3길 62 파동평생학습센터 1층',no:'70' });
	daegu_map_data.push({idx:'54',title:'무학숲도서관', tel : '053-668-1821', point:{x:'35.8352614435461',y:'128.630574771678'}, address:'대구광역시 수성구 청수로40길 73-10(지산동)',no:'71' });
	daegu_map_data.push({idx:'53',title:'책숲길도서관', tel : '053-668-1811', point:{x:'35.8448425307153',y:'128.612376649774'}, address:'대구광역시 수성구 수성로215(중동) 수옥빌딩 4층',no:'72' });
	daegu_map_data.push({idx:'52',title:'물망이도서관', tel : '053-666-4390', point:{x:'35.8547657653853',y:'128.619007545444'}, address:'대구광역시 수성구 명덕로 443-2(수성동3가) 수성2,3가동 행정복지센터 4층',no:'73' });
	daegu_map_data.push({idx:'51',title:'사월역작은도서관', tel : '053-792-8582', point:{x:'35.8367666856083',y:'128.715362349733'}, address:'대구광역시 수성구 달구벌대로 지하 1층 3290(신매동)',no:'74' });
	
	/* 달서구 */
	daegu_map_data.push({idx:'59',title:'대구광역시립두류도서관', tel : '053-231-2700', point:{x:'35.8526137879105',y:'128.560435130444'}, address:'대구광역시 달서구 공원순환로 8',no:'75' });
	daegu_map_data.push({idx:'58',title:'성서도서관', tel : '053-667-4900', point:{x:'35.8574115335529',y:'128.514459232431'}, address:'대구광역시 달서구 선원남로 129 (이곡동)',no:'76' });
	daegu_map_data.push({idx:'57',title:'달서어린이도서관', tel : '053-667-4860', point:{x:'35.8224803563508',y:'128.547014357069'}, address:'대구광역시 달서구 송현로 45(상인동)',no:'77' });
	daegu_map_data.push({idx:'56',title:'도원도서관', tel : '053-667-4840', point:{x:'35.8067933787751',y:'128.5390485116'}, address:'대구광역시 달서구 한실로 113(도원동)',no:'78' });
	daegu_map_data.push({idx:'55',title:'본리도서관', tel : '053-667-4930', point:{x:'35.8405592500203',y:'128.541813956432'}, address:'대구광역시 달서구 당산로 37-25(본리동)',no:'79' });
	daegu_map_data.push({idx:'54',title:'달서가족문화도서관', tel : '053-667-4970', point:{x:'35.8174869853999',y:'128.519186842697'}, address:'대구광역시 달서구 조암남로 137 (대천동)',no:'80' });
	daegu_map_data.push({idx:'53',title:'달서영어도서관', tel : '053-667-4950', point:{x:'35.831256500065',y:'128.555213095042'}, address:'대구광역시 달서구 중흥로 6길 10 (송현동)',no:'81' });
	daegu_map_data.push({idx:'52',title:'이곡2동작은도서관', tel : '053-667-4368', point:{x:'35.8557547032754',y:'128.500776149161'}, address:'대구광역시 달서구 계대동문로77 (이곡동 1191-3)',no:'82' });
	daegu_map_data.push({idx:'51',title:'용산1동작은도서관', tel : '053-667-4279', point:{x:'35.8566624983138',y:'128.531223930229'}, address:'대구광역시 달서구 용산로212-7 (용산동 934-6)',no:'83' });
	daegu_map_data.push({idx:'49',title:'장기동작은도서관', tel : '053-667-4244', point:{x:'35.8433491694642',y:'128.529974709497'}, address:'대구광역시 달서구 장기로277 (장기동 817-2)',no:'84' });
	daegu_map_data.push({idx:'48',title:'죽전동작은도서관', tel : '053-667-4214', point:{x:'35.8557951418932',y:'128.539806645735'}, address:'대구광역시 달서구 와룡로54길 28 (죽전동 204-12)',no:'85' });
	daegu_map_data.push({idx:'47',title:'달서아트센터도서관', tel : '053-584-9274', point:{x:'35.843422578812',y:'128.522826730437'}, address:'대구광역시 달서구 문화회관길160 (장기동 722-1) ',no:'86' });
	daegu_map_data.push({idx:'46',title:'행정정보문고센터', tel : '053-667-4815', point:{x:'35.8295250192427',y:'128.532293871771'}, address:'대구광역시 달서구 학산로 45 (월성동 281)',no:'87' });
	daegu_map_data.push({idx:'45',title:'학산작은도서관', tel : '053-721-8970', point:{x:'35.8332859011084',y:'128.541804663116'}, address:'대구광역시 달서구 학산로 140(본동 804-2)',no:'88' });
	daegu_map_data.push({idx:'44',title:'대구학생문화센터', tel : '053-231-1254', point:{x:'35.8530407',y:'128.5294985'}, address:'대구광역시 달서구 용산로 181 대구학생문화센터 2층',no:'89' });
	daegu_map_data.push({idx:'43',title:'점자도서관', tel : '053-256-8877', point:{x:'35.831016',y:'128.552125'}, address:'대구광역시 달서구 월배로 414 (송현동)',no:'90' });
	daegu_map_data.push({idx:'42',title:'새벗도서관', tel : '053-631-9105', point:{x:'35.8168531',y:'128.5326179'}, address:'대구광역시 달서구 월배로 170 (상인동)',no:'91' });
	daegu_map_data.push({idx:'41',title:'푸른초장공공도서관', tel : '053-582-3394', point:{x:'35.8536579',y:'128.4738303'}, address:'대구광역시 달서구 달구벌대로 973',no:'92' });

	/* 달성군 */
	daegu_map_data.push({idx:'59',title:'대구광역시립달성도서관', tel : '053-231-2150', point:{x:'35.6987734244329',y:'128.447687886093'}, address:'대구광역시 달성군 현풍면 현풍동로19길 26',no:'93' });
	daegu_map_data.push({idx:'58',title:'달성군립도서관', tel : '053-231-2150', point:{x:'35.8592968795804',y:'128.462410475657'}, address:'대구광역시 달성군 다사읍 달구벌대로174길 10-13',no:'94' });
	daegu_map_data.push({idx:'57',title:'화원읍작은도서관', tel : '053-668-3346', point:{x:'35.8042335195515',y:'128.500718751053'}, address:'대구광역시 달성군 화원읍 비슬로 2594 (군민독서실1,2층)',no:'95' });
	daegu_map_data.push({idx:'56',title:'논공읍작은도서관', tel : '053-615-9191', point:{x:'35.7301956975906',y:'128.45178080326'}, address:'대구광역시 달성군 논공읍 논공로 697-9 (종합사회복지관2층)',no:'96' });
	daegu_map_data.push({idx:'55',title:'다사읍작은도서관', tel : '053-591-3342', point:{x:'35.8648158934292',y:'128.457307362395'}, address:'대구광역시 달성군 다사읍 매곡로12길 37 (다사읍자치센터별관)',no:'97' });
	daegu_map_data.push({idx:'54',title:'다사읍서재작은도서관', tel : '053-588-6261', point:{x:'35.8722208677966',y:'128.494256685648'}, address:'대구광역시 달성군 다사읍 서재본길 25 (다사서재출장소2층)',no:'98' });
	daegu_map_data.push({idx:'52',title:'유가읍작은도서관', tel : '053-614-8048', point:{x:'35.6943341355787',y:'128.459646544423'}, address:'대구광역시 달성군 유가읍 테크노상업로 95 (유가읍사무소2층)',no:'99' });
	daegu_map_data.push({idx:'51',title:'옥포읍작은도서관', tel : '053-614-8314', point:{x:'35.7893939008833',y:'128.463403781067'}, address:'대구광역시 달성군 옥포읍 비슬로 2215 (옥포읍자치센터1층)',no:'100' });
	daegu_map_data.push({idx:'49',title:'가창면 참꽃작은도서관', tel : '053-760-7731', point:{x:'35.8023200879016',y:'128.623413571364'}, address:'대구광역시 달성군 가창면 가창로220길 8 (청소년문화의집1층)',no:'101' });
	daegu_map_data.push({idx:'48',title:'하빈면작은도서관', tel : '053-582-5610', point:{x:'35.8995133295819',y:'128.445876932419'}, address:'대구광역시 달성군 하빈면 하빈로84길 23 (하빈면민복지회관3층)',no:'102' });
	daegu_map_data.push({idx:'47',title:'구지면작은도서관', tel : '053-614-0985', point:{x:'35.6604041035004',y:'128.415118518014'}, address:'대구광역시 달성군 구지면 창리로11길 90 (구.구지면 농촌상담소)',no:'103' });
	daegu_map_data.push({idx:'46',title:'달성군청소년센터 작은도서관', tel : '053-670-1323', point:{x:'35.7238932618227',y:'128.455082141863'}, address:'대구광역시 달성군 논공읍 논공로 252 (청소년센터3층)',no:'104' });
	daegu_map_data.push({idx:'45',title:'달성군청도서관', tel : '053-668-3239', point:{x:'35.7746629175875',y:'128.43138936958'}, address:'대구광역시 달성군 논공읍 달성군청로 33 (달성군청)',no:'105' });
	daegu_map_data.push({idx:'44',title:'비전도서관', tel : '053-639-2140', point:{x:'35.8060901',y:'128.5057505'}, address:'대구광역시 달성군 화원읍 인흥길 11 (천내리)',no:'106' });
	daegu_map_data.push({idx:'43',title:'아트도서관', tel : '053-952-5252', point:{x:'35.7254625',y:'128.6551319'}, address:'대구광역시 달성군 가창면 우록길 131 (우록리)',no:'107' });
