...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	<div class="head">
		<div class="Gnb">
			...
			<h1 class="web-logo"><a href="/${homepage.context_path}/index.do">부산학 디지털 아카이브</a></h1>

			<!-- menu S -->
			<div class="g-menu">
				<homepageTag:topMenu menuList="${menuTreeList}" />

				<a href="/${homepage.context_path}/sitemap/index.do?menu_idx=64" class="last-box"><img src="/resources/homepage/${homepage.context_path}/img/sitemap_icon.png" alt="사이트맵" /></a>
