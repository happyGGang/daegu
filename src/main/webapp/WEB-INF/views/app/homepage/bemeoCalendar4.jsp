	...
	<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
		<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
			...
			<div class="doc-body">
				...
				<h3>주제별 자료현황<span class="sm_text sm_text02" style="margin-top:10px;">[2023.10.31. 기준] (단위 : 권)</span></h3>
				...
				<h3>별치기호별 자료현황<span class="sm_text sm_text02" style="margin-top:10px;">[2023.10.31. 기준] (단위 : 권)</span></h3>
				<div class="rsv-info"></div>
				<div class="auto-scroll">
				...
				<p>보존서고: 6,508권 포함</p>
				<h3>간행물 현황<span class="sm_text sm_text02" style="margin-top:10px;">[2023.10.31. 기준] (단위 : 권)</span></h3>
				<div class="rsv-info"></div>
				<div class="auto-scroll">
				...
				<ul class="bus_list">
					<li><a href="http://businfo.daegu.go.kr/ba/index/index.do" target="_blank" class="newWin"
							title="새창으로 열립니다."><span class="ico_bus_m">간선<span class="num">100</span></span><i
								class="fa fa-external-link"></i></a></li>
					<li><a href="http://businfo.daegu.go.kr/ba/index/index.do" target="_blank" class="newWin"
							title="새창으로 열립니다."><span class="ico_bus_m">간선<span class="num">204</span></span><i
								class="fa fa-external-link"></i></a></li>
					<li><a href="http://businfo.daegu.go.kr/ba/index/index.do" target="_blank" class="newWin"
							title="새창으로 열립니다."><span class="ico_bus_m">간선<span class="num">234</span></span><i
								class="fa fa-external-link"></i></a></li>
					<li><a href="http://businfo.daegu.go.kr/ba/index/index.do" target="_blank" class="newWin"
							title="새창으로 열립니다."><span class="ico_bus_m">간선<span class="num">814</span></span><i
								class="fa fa-external-link"></i></a></li>
					<li><a href="http://businfo.daegu.go.kr/ba/index/index.do" target="_blank" class="newWin"
							title="새창으로 열립니다."><span class="ico_bus_m">간선<span class="num">8140</span></span><i
								class="fa fa-external-link"></i></a></li>
					<li><a href="http://businfo.daegu.go.kr/ba/index/index.do" target="_blank" class="newWin"
							title="새창으로 열립니다."><span class="ico_bus_j">지선<span class="num">수성1</span></span><i
								class="fa fa-external-link"></i></a></li>
					<li><a href="http://businfo.daegu.go.kr/ba/index/index.do" target="_blank" class="newWin"
							title="새창으로 열립니다."><span class="ico_bus_j">지선<span class="num">수성1-1</span></span><i
								class="fa fa-external-link"></i></a></li>
					<li><a href="http://businfo.daegu.go.kr/ba/index/index.do" target="_blank" class="newWin"
							title="새창으로 열립니다."><span class="ico_bus_g">급행<span class="num">급행3</span></span><i
								class="fa fa-external-link"></i></a></li>
					<div class="clear"></div>
				</ul>
				<p class="basic_btn">
				...
				<h3>자가용 이용시</h3>
				<ul class="con">
					<li>시내방향에서 오시는 경우: 달구벌대로를 따라 이동 후 범어네거리에서 ‘수성구민운동장’ 방면으로 900m 지점 우회전 한 뒤, 어린이회관삼거리에서 1.4km 지점 우회전 한 뒤, ‘청솔로4길‘
						방면으로 700m 지점</li>
