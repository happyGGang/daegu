			...
			<div class="main-visual">
				...
				<div class="swiper-container mySwiper">
					<div class="swiper-wrapper">
						<div class="swiper-slide mvimg01"><div class="mvText">책 속에서 만나는 기적, 도서관에서 꿈꾸는 희망<strong>수성구립 용학도서관</strong></div></div>
						<div class="swiper-slide mvimg02"><div class="mvText">책 속에서 만나는 기적, 도서관에서 꿈꾸는 희망<strong>수성구립 용학도서관</strong></div></div>
						<div class="swiper-slide mvimg03"><div class="mvText">책 속에서 만나는 기적, 도서관에서 꿈꾸는 희망<strong>수성구립 용학도서관</strong></div></div>
					</div>
			...
			<div class="main1-top">
				<div class='main-section'>
									...
									<c:forEach items="${noticeList}" var="i" varStatus="status" begin="0" end="4">
										<li>
											<a href="/${homepage.context_path}/board/view.do?menu_idx=35&manage_idx=677&board_idx=${i.board_idx}">
												<span class="sulib001">${i.category1_name}</span>
												<em>${i.title}</em>
					...
					<div class="information-box">
						<ul>
							<li><span>어린이자료실(2층)</span>평일 09:00 - 18:00 / 주말 09:00 - 17:00</li>
							<li><span>종합자료실(3층)</span>평일 09:00 - 20:00 / 주말 09:00 - 17:00</li>
							<li><span>일반열람실(5층)</span>※코로나19로 인한 사회적 거리두기에 따라 잠정 이용중단</li>
						</ul>
				...
				<div class="top-box">
					<div class="main-section">
						...
						<div class="sns-link">
							<ul>
								<li>
									<a href="https://www.youtube.com/channel/UCSgiTt1jno9W6xoD84zXnVg" target="_blank">
								...
								<li>
									<a href="https://www.instagram.com/yonghaklibrary/" target="_blank">
					...
					<div class="main-section">
						<div class="book-box">
							<div class="book-tit-box">
								<h2>추천도서</h2>
								<p>수성구립 용학도서관에서 <Br class='webBr'/>추천드리는 도서를 <Br class='webBr'/>소개합니다.</p>
							</div>
