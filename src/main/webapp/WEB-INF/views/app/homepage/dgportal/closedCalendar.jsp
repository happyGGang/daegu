...
$(function() {
	...
	$('a#prevHoliday').on('click', function(e) {
	...
	$('a#nextHoliday').on('click', function(e) {
		var plan_date = new Date($(this).attr('keyValue'));
		plan_date.setMonth(plan_date.getMonth() + 1);
		$('div.holiday-box').load('calendar2.do', 'plan_date='+plan_date.format('yyyy-MM'));
		e.preventDefault();
...
<div class="bx-controls-direction">
	<a id="prevHoliday" class="bx-prev" href="" keyValue="${calendar.plan_date}">Prev</a>
	<a id="nextHoliday" class="bx-next" href="" keyValue="${calendar.plan_date}">Next</a>
</div>