				...
				<div class='main-section'>
					...
					<div class="notice-box tabS">
						<ul class="tabMenuS">
							...
							<li><a href="#tab2" data-link="/${homepage.context_path}/module/teach/index.do?menu_idx=98&searchCate1=16" class='t-tabs'>문화행사</a></li>
						</ul>
							...
							<div class="box">
								<ul>
									<c:forEach items="${teachList}" var="i" varStatus="status" begin="0" end="4">
										...
										<li>
											<a href="/${homepage.context_path}/module/teach/detail.do?menu_idx=${teachMenuIdx}&homepage_id=${i.homepage_id}&group_idx=${i.group_idx}&category_idx=${i.category_idx}&teach_idx=${i.teach_idx}&searchCate1=${i.large_category_idx}">
					...
					<div class="information-box">
						<ul>
							...
							<li><span>종합자료실1,2,3</span>평일 09:00 - 22:00 / 주말 09:00 - 17:00</li>
