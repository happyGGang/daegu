	...
	<div class="mFooter">
		...
		<div class="bottom">
			<div class="sections">
				...
				<p class="copyright">Copyright © 2020 DAEGU METROPOLITAN BEOMEO LIBRARY, <br class="mobileBr"/>All rights reserved.</p>
				<p class="f_logo"><img src="/resources/homepage/${homepage.context_path}/img/footer_logo.png" alt="범어도서관"></p>
			</div>
		</div>
