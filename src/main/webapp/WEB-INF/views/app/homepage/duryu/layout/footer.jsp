    ...
    <div class="top">
        <div class="section">
            <div class="info">
                ...
                <span class="bar">|</span>
				<a href="/${homepage.context_path}/board/index.do?menu_idx=226&manage_idx=1340">이전영상정보처리방침</a>
                <span class="bar">|</span>
    ...
    <div class="bottom">
        <div class="section" style="position:relative;">
            <address>
                ...
                <span>Copyright © 2020 DAEGU METROPOLITAN DURYU LIBRARY, <br class="mobileBr"/>All rights reserved.</span>
            </address>
            <div class="site_link">
                <div>
