    ...
    <div class="wrapper">
        <div class="library-info">
            <div class="link_list">
                ...
                <a href="https://library.daegu.go.kr/duryu/html.do?menu_idx=89">이용약관</a>
                <a href="https://library.daegu.go.kr/duryu/html.do?menu_idx=88">영상정보처리방침</a>
                <a href="https://library.daegu.go.kr/duryu/html.do?menu_idx=90">도서관헌장</a>
                <a href="https://library.daegu.go.kr/duryu/html.do?menu_idx=91">저작권신고</a>
                <a href="https://library.daegu.go.kr/duryu/sitemap/index.do?menu_idx=92">사이트맵</a>
                <a href="https://library.daegu.go.kr/duryu/html.do?menu_idx=94">성고충상담창구</a>
                <a href="https://library.daegu.go.kr/duryu/html.do?menu_idx=109">찾아오시는길</a>
            </div>
            <div class="library-detail">
                <div class="library-name">두류도서관</div>
...
<div class="footer-wrapper footer-bottom">
    <div class="wrapper">
        ...
        <div class="move-select">
            ...
            <div class="select-wrapper">
                <select>
                    <option value="" selected>교육 및 지역관련기관</option>
