...
<div id="header">
    ...
    <div class="tnb">
        ...
        <div class="util-wrapper">
            <div class="util">
                <div class="sns-box">
                    <a href="https://pf.kakao.com/_xbIxlJb"><img src="/resources/homepage/${homepage.context_path}/img/common/kakaotalk-color.svg" alt=""></a>
                    <a href="https://www.instagram.com/${homepage.context_path}lib/"><img src="/resources/homepage/${homepage.context_path}/img/common/instagram-color.svg" alt=""></a>
                    <a href="https://www.youtube.com/channel/UCLIjzSfEz4vRczvr02hMy2w/featured"><img src="/resources/homepage/${homepage.context_path}/img/common/youtube-color.svg" alt=""></a>
                </div>
                <a href="/${homepage.context_path}/index.do">메인으로</a>
