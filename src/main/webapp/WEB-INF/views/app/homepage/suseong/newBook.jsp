...
<c:choose>
	<c:when test="${fn:length(newBookList) > 0}">
		<img class="book-slide-prev" src="/resources/homepage/${homepage.context_path}/img/book/arrow-left-white.svg" alt="">
		...
		<img class="book-slide-next" src="/resources/homepage/${homepage.context_path}/img/book/arrow-right-white.svg" alt="">
	</c:when>
	<c:otherwise>
