...
$(function() {
	...
	$('a.elib-left-menu').on('click', function(e) {
		e.preventDefault();
		var url = '/${homepage.context_path}/module/newelib/book/index.do';
		...
		<div class="qmenu sublink">
			<div style="overflow:hidden;">
				<ul data-call="bxslider" data-breaks="[{screen:0, slides:4},{screen:340, slides:4},{screen:450, slides:5},{screen:600, slides:5},{screen:767, slides:5},{screen:1000, slides:8}]">
					<li><a href="/${homepage.context_path}/module/newelib/book/index.do?menu_idx=14&menu=NEW&type=EBK"><img src="/resources/homepage/elib/img/icon001.png" alt=""><br/>E-BOOK</a></li>
					...
					<li><a href="/${homepage.context_path}/board/index.do?menu_idx=72&manage_idx=284"><img src="/resources/homepage/elib/img/icon005.png" alt=""><br/>공지사항</a></li>
					<li><a href="/${homepage.context_path}/intro/login/mobileCard.do?menu_idx=81"><img src="/resources/homepage/elib/img/icon006.png" alt=""><br/>모바일회원증</a></li>

					<li><a href="/${homepage.context_path}/module/newelib/asp/contents/elearning.do?menu_idx=27"><img src="/resources/homepage/elib/img/icon003.png" alt=""><br/>E-러닝</a></li>
					<li><a href="/${homepage.context_path}/html.do?menu_idx=24"><img src="/resources/homepage/elib/img/icon004.png" alt=""><br/>웹DB</a></li>

					<li><a href="/${homepage.context_path}/html.do?menu_idx=31"><img src="/resources/homepage/elib/img/icon007.png" alt=""><br/>이용안내</a></li>
					<li><a href="/${homepage.context_path}/module/newelib/lending/index.do?menu_idx=39&menu=LENDING"><img src="/resources/homepage/elib/img/icon008.png" alt=""><br/>나의도서관</a></li>
				</ul>
			</div>
		</div>
	...
	<div id="sub-container" class="sub container">
		...
		<div class="section">
			...
			<div class="lnb">
				...
				<ul class="SubMenu">
					<li id="menu_${menu_idx_new}"<c:if test="${param.menu_idx == menu_idx_new}"> class="active"</c:if>><a href="/newelib/module/newelib/book/index.do?menu_idx=${menu_idx_new}&menu=NEW&type=${fn:escapeXml(param.type)}"><span>신착${label}</span></a></li>
					<c:choose>
					<c:when test="${param.type == 'EBK'}">
					<li id="menu_${menu_idx_best}"<c:if test="${param.menu_idx == menu_idx_best}"> class="active"</c:if>><a href="/newelib/module/newelib/book/index.do?menu_idx=${menu_idx_best}&menu=BEST&type=${fn:escapeXml(param.type)}"><span>인기${label}</span></a></li>
					</c:when>
					<c:otherwise>
					<li id="menu_${menu_idx_best}"<c:if test="${param.menu_idx == menu_idx_best}"> class="active"</c:if>><a href="/newelib/module/newelib/book/index.do?menu_idx=${menu_idx_best}&menu=RECOMMEND&type=${fn:escapeXml(param.type)}"><span>인기${label}</span></a></li>
					</c:otherwise>
					</c:choose>
					...
					<ul class="SubMenu">
						<c:if test="${not empty categoryMenuList}">
							<li id="menu_${menu_idx_category}"><a href="/newelib/module/newelib/book/index.do?menu_idx=${menu_idx_category}&menu=CATEGORY&type=${fn:escapeXml(param.type)}"><span>주제별</span></a>
						...
						<c:if test="${not empty compMenuList}">
							<li id="menu_${menu_idx_provider}"><a href="/newelib/module/newelib/book/index.do?menu_idx=${menu_idx_provider}&menu=PROVIDER&type=${fn:escapeXml(param.type)}"><span>유통사별</span></a>
								<ul class="SubMenu" style="display: block;">
