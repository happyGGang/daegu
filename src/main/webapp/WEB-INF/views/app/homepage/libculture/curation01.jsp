		...
		return false;
					...
					<div class="mainSection01">
						<div class="innerBox">
							...
							<div class="slickPlay">
								<p class="status"><span>1</span> / 104</p>
								<a href="#" class="play">시작</a>
								<a href="#" class="pause">멈춤</a>
							</div>
							<div class="slickWrap" data-animation="fadeInUp">
								<div>
									<a href="http://icuration.co.kr:81/curation/w/232" target="_blank" class="newWin" title="새창으로 열립니다.">
										<h2>문화예술</h2>
										<p class="img"><img src="/resources/homepage/${homepage.context_path}/img/ct_img_14.png" alt="8월의 영화제" /></p>
										<span class="link">8월의 영화제<i></i></span>
									</a>
								</div>
								<div>
									<a href="http://icuration.co.kr:81/curation/w/233" target="_blank" class="newWin" title="새창으로 열립니다.">
										<h2>제작체험</h2>
										<p class="img"><img src="/resources/homepage/${homepage.context_path}/img/ex_img_14.png" alt="내 손 안의 바다" /></p>
										<span class="link">내 손 안의 바다<i></i></span>
									</a>
								</div>
								<div>
									<a href="http://icuration.co.kr:81/curation/w/230" target="_blank" class="newWin" title="새창으로 열립니다.">
										<h2>동화</h2>
										<p class="img"><img src="/resources/homepage/${homepage.context_path}/img/dh_img_13.png" alt="동화책으로 배우는 기본 상식" /></p>
										<span class="link">동화책으로 배우는 기본 상식<i></i></span>
									</a>
								</div>
								<div>
									<a href="http://icuration.co.kr:81/curation/w/229" target="_blank" class="newWin" title="새창으로 열립니다.">
										<h2>힐링</h2>
										<p class="img"><img src="/resources/homepage/${homepage.context_path}/img/hl_img_13.png" alt="현대인의 힐링 디지털 디톡스" /></p>
										<span class="link">현대인의 힐링 디지털 디톡스<i></i></span>
									</a>
								</div>
								<div>
									<a href="http://icuration.co.kr:81/curation/w/228" target="_blank" class="newWin" title="새창으로 열립니다.">
										<h2>역사</h2>
										<p class="img"><img src="/resources/homepage/${homepage.context_path}/img/ht_img_13.png" alt="이색 박물관을 찾아서" /></p>
										<span class="link">이색 박물관을 찾아서<i></i></span>
									</a>
								</div>
								<div>
								...
								<div>
									<a href="http://icuration.co.kr:81/curation/w/221" target="_blank" class="newWin" title="새창으로 열립니다.">
										<h2>문화예술</h2>
										<p class="img"><img src="/resources/homepage/${homepage.context_path}/img/ct_img_13.png" alt="이달의 클래식" /></p>
										<span class="link">이달의 클래식<i></i></span>
									</a>
								</div>
								<div>
								...
								<div>
									<a href="http://icuration.co.kr:81/curation/w/219" target="_blank" class="newWin" title="새창으로 열립니다.">
										<h2>동화</h2>
										<p class="img"><img src="/resources/homepage/${homepage.context_path}/img/dh_img_12.png" alt="작고 소중한 나의 가족" /></p>
										<span class="link">작고 소중한 나의 가족<i></i></span>
									</a>
								</div>
								<div>
									<a href="http://icuration.co.kr:81/curation/w/218" target="_blank" class="newWin" title="새창으로 열립니다.">
										<h2>그림책</h2>
								...
								<div>
									<a href="http://icuration.co.kr:81/curation/w/215" target="_blank" class="newWin" title="새창으로 열립니다.">
										<h2>힐링</h2>
								...
								<div>
									<a href="http://icuration.co.kr:81/curation/w/214" target="_blank" class="newWin" title="새창으로 열립니다.">
										<h2>제작/체험</h2>
										<p class="img"><img src="/resources/homepage/${homepage.context_path}/img/ex_img_13.png" alt="빵빵한 하루 베이킹 클래스" /></p>
										<span class="link">빵빵한 하루 베이킹 클래스<i></i></span>
									</a>
								</div>
								<div>
									<a href="http://icuration.co.kr:81/curation/w/211" target="_blank" class="newWin" title="새창으로 열립니다.">
										<h2>역사</h2>
										<p class="img"><img src="/resources/homepage/${homepage.context_path}/img/ht_img_12.png" alt="전통의 멋 한복 이야기" /></p>
										<span class="link">전통의 멋 한복 이야기<i></i></span>
									</a>
								</div>
								<div>
									<a href="http://icuration.co.kr:81/curation/w/210" target="_blank" class="newWin" title="새창으로 열립니다.">
										<h2>인문</h2>
								...
								<div>
									<a href="http://icuration.co.kr:81/curation/w/207" target="_blank" class="newWin" title="새창으로 열립니다.">
										<h2>문화예술</h2>
										<p class="img"><img src="/resources/homepage/${homepage.context_path}/img/ct_img_12.png" alt="깎아냄의 미학" /></p>
										<span class="link">깎아냄의 미학<i></i></span>
									</a>
								</div>
								<div>
								...
								<div>
									<a href="http://icuration.co.kr:81/curation/w/205" target="_blank" class="newWin" title="새창으로 열립니다.">
										<h2>제작/체험</h2>
										<p class="img"><img src="/resources/homepage/${homepage.context_path}/img/ex_img_12.png" alt="내가 꾸민 크리스마스" /></p>
										<span class="link">내가 꾸민 크리스마스<i></i></span>
									</a>
								</div>
								<div>
									<a href="http://icuration.co.kr:81/curation/w/206" target="_blank" class="newWin" title="새창으로 열립니다.">
										<h2>그림책</h2>
								...
								<div>
									<a href="http://icuration.co.kr:81/curation/w/201" target="_blank" class="newWin" title="새창으로 열립니다.">
										<h2>힐링</h2>
										<p class="img"><img src="/resources/homepage/${homepage.context_path}/img/hl_img_11.png" alt="나를 위한 티타임" /></p>
										<span class="link">나를 위한 티타임<i></i></span>
									</a>
								</div>
								<div>
