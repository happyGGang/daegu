					...
					<div class="mainSection06">
						<div class="innerBox">
							...
							<div class="slickWrap" data-animation="fadeInUp">
								<div>
									<a href="http://www.icuration.co.kr:81/curation/w/229" target="_blank" class="newWin" title="새창으로 열립니다.">
										<h2>힐링</h2>
								...
								<div>
									<a href="http://www.icuration.co.kr:81/curation/w/183" target="_blank" class="newWin" title="새창으로 열립니다.">
										<h2>힐링</h2>
								...
								<div>
									<a href="http://www.icuration.co.kr:81/curation/w/174" target="_blank" class="newWin" title="새창으로 열립니다.">
										<h2>힐링</h2>
