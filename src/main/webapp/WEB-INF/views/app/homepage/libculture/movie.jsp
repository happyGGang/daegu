...
<div class="slideList mainSec00 main0Section01">
	<div class="innerBox">
		...
		<div class="slickPlay">
			<p class="status"><span> 01</span> / <fmt:formatNumber var="no" minIntegerDigits="2" value="${fn:length(movieViewList)}" type="number"/> ${no}</p>
			<a href="#" class="play">시작</a>
			<a href="#" class="pause">멈춤</a>
		</div>
		<div class="slickWrap" data-animation="fadeInUp">
			<c:forEach var="i" items="${movieViewList}">
				<div>
...
<div class="point-img">
	<img src="/resources/homepage/${homepage.context_path}/img/movie-img.png" alt="">
</div>