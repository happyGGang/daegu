		...
		return false;
					...
					<div class="mainSection05">
						<div class="innerBox">
							...
							<div class="slickPlay">
								<p class="status"><span>1</span> / 14</p>
								<a href="#" class="play">시작</a>
								<a href="#" class="pause">멈춤</a>
							</div>
							<div class="slickWrap" data-animation="fadeInUp">
								<div>
									<a href="http://www.icuration.co.kr:81/curation/w/233" target="_blank" class="newWin" title="새창으로 열립니다.">
										<h2>제작/체험</h2>
								...
								<div>
									<a href="http://www.icuration.co.kr:81/curation/w/214" target="_blank" class="newWin" title="새창으로 열립니다.">
										<h2>제작/체험</h2>
								...
								<div>
									<a href="http://www.icuration.co.kr:81/curation/w/205" target="_blank" class="newWin" title="새창으로 열립니다.">
										<h2>제작/체험</h2>
								...
								<div>
									<a href="http://www.icuration.co.kr:81/curation/w/194" target="_blank" class="newWin" title="새창으로 열립니다.">
										<h2>제작/체험</h2>
								...
								<div>
									<a href="http://www.icuration.co.kr:81/curation/w/185" target="_blank" class="newWin" title="새창으로 열립니다.">
										<h2>제작/체험</h2>
								...
								<div>
									<a href="http://www.icuration.co.kr:81/curation/w/178" target="_blank" class="newWin" title="새창으로 열립니다.">
										<h2>제작/체험</h2>
								...
								<div>
									<a href="http://www.icuration.co.kr:81/curation/w/169" target="_blank" class="newWin" title="새창으로 열립니다.">
										<h2>제작/체험</h2>
