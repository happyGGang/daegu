...
<style>
	...
	.box_area ul li{display: block;float:left;width:265px;margin: 10px 0 0 15px;background:#fff;transition:all 0.3s ease;border-radius: 2px;}
	.box_area ul li a{display:block; padding-left:30px;height:50px;line-height:50px;vertical-align:middle; font-size:15px;color:#444;transition:all 0.2s ease;}
...
<div class="pro_seat">
  <div class="box_area blue">
    ...
    <div class="seat1">
      <ul>
        <li><a href="https://library.daegu.go.kr/jungang/html/hopeBook.do?menu_idx=222" target="_blank" class="newWin" title="대구광역시립중앙도서관 희망도서바로대출 안내 페이지 이동(새창열림)">대구광역시립중앙도서관<i class="fa fa-external-link"></i></a></li>
        ...
        <li><a href="https://library.daegu.go.kr/nambu/html/hopeBook.do?menu_idx=215" target="_blank" class="newWin" title="대구광역시립남부도서관 희망도서바로대출 안내 페이지 이동(새창열림)">대구광역시립남부도서관<i class="fa fa-external-link"></i></a></li>
        <li><a href="https://library.daegu.go.kr/namic/html/hopeBook.do?menu_idx=105" target="_blank" class="newWin" title="남구 이천어울림도서관 희망도서바로대출 안내 페이지 이동(새창열림)">남구 이천어울림도서관<i class="fa fa-external-link"></i></a></li>
        <li><a href="https://library.daegu.go.kr/bukbu/html/hopeBook.do?menu_idx=187" target="_blank" class="newWin" title="대구광역시립북부도서관 희망도서바로대출 안내 페이지 이동(새창열림)">대구광역시립북부도서관<i class="fa fa-external-link"></i></a></li>
        <li><a href="https://library.daegu.go.kr/bukgs/html/hopeBook.do?menu_idx=119" target="_blank" class="newWin" title="북구 구수산도서관 희망도서바로대출 안내 페이지 이동(새창열림)">북구 구수산도서관<i class="fa fa-external-link"></i></a></li>
        <li><a href="https://library.daegu.go.kr/suseong/html/hopeBook.do?menu_idx=185" target="_blank" class="newWin" title="대구광역시립수성도서관 희망도서바로대출 안내 페이지 이동(새창열림)">대구광역시립수성도서관<i class="fa fa-external-link"></i></a></li>
        <li><a href="https://library.daegu.go.kr/beomeo/html/hopeBook.do?menu_idx=167" target="_blank" class="newWin" title="수성구 범어도서관 희망도서바로대출 안내 페이지 이동(새창열림)">수성구 범어도서관<i class="fa fa-external-link"></i></a></li>
        <li><a href="https://library.daegu.go.kr/yonghak/html/hopeBook.do?menu_idx=174" target="_blank" class="newWin" title="수성구 용학도서관 희망도서바로대출 안내 페이지 이동(새창열림)">수성구 용학도서관<i class="fa fa-external-link"></i></a></li>
...
<div class="hopeBook_box">
	<div class="move">
		<c:choose>
			...
			<c:otherwise>
				<a href="#none" onclick="alert('로그인후 이용바랍니다.');location.href='/${homepage.context_path}/intro/login/index.do?menu_idx=${param.menu_idx}&before_url=/${homepage.context_path}/html/barohbook.do?menu_idx=${param.menu_idx}';" class="ebook_links" /><span style="margin-right:5px;">희망도서바로대출 바로가기 &gt;</span><!--<span class="ico arr"></span><i class="fa fa-external-link"></i>--></a> 
			</c:otherwise>
		</c:choose>
	</div>
</div>