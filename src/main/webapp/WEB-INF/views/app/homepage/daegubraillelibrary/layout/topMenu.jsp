		...
		<div class="Gnb">
			...
			<div class="main-section2">
				...
				<div class="g-menu">
					...
					<a href="/${homepage.context_path}/sitemap/index.do?menu_idx=71" class="last-box_w"><img src="/resources/common/img/sitemap_icon_white.png" alt="사이트맵" /></a>
					<a href="/${homepage.context_path}/sitemap/index.do?menu_idx=71" class="last-box_b"><img src="/resources/common/img/sitemap_icon_black.png" alt="사이트맵" /></a>
					<div class="mmode">
