...
jQuery(function($){
	...
	daegu_map_data.push({idx:'48',title:'하빈면작은도서관', tel : '053-582-5610', point:{x:'35.8995133295819',y:'128.445876932419'}, address:'대구광역시 달성군 하빈면 하빈로84길 23 (하빈면민복지회관3층)',no:'10' });
