		...
		<div class="main-section">
			<div class="libSite">
				<ul>
					...
					<li class="on"><a href="/buksb/index.do">서변숲</a></li>
			...
			<div class="util">
				<c:choose>
					<c:when test="${sessionScope.member.loginType eq 'HOMEPAGE' and sessionScope.member.login}">
						...
						<span class="txt-bar"></span>
						<a href="/${homepage.context_path}/intro/join/modifyCheck.do?menu_idx=75">정보수정</a>
					</c:when>
					...
					<c:otherwise>
						<a href="/${homepage.context_path}/intro/login/index.do?menu_idx=82">통합허브시스템 로그인</a>
						<span class="txt-bar"></span>
						<a href="/${homepage.context_path}/intro/join/integration.do?menu_idx=86">통합회원인증</a>
						<span class="txt-bar"></span>
						<a href="/${homepage.context_path}/intro/join/index.do?menu_idx=83">회원가입</a>
					</c:otherwise>
				</c:choose>
			</div>
