...
<div class="swiper-wrap-box">
  <div class="top_swiper">
        ...
        <c:forEach items="${bookList1}" var="i" varStatus="status">
          <div class="swiper-slide">
            <div
              ...
              onclick="location.href='/${homepage.context_path}/board/view.do?menu_idx=15&manage_idx=${i.manage_idx}&board_idx=${i.board_idx}'"
            >
              <div>${i.title}</div>
              <img
    ...
    <div class="book_list_more">
      <a
        href="/${homepage.context_path}/board/index.do?menu_idx=14&manage_idx=1284"
      >
        <img
          class="book_thumbnail_arrow"
