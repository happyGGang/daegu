...
$(function() {
	...
	$('#search_keyword').on('click',function(e){
		...
		*/
		...
		if(member_name == ''){
			...
			doGetLoad('gukboBookKeywordList.do', param);
		} else {
	...
	$('div.keyword-box').load('gukboBookKeyword.do');
...
<div class="smartrecommandbook-wrap">
	...
	<div class="contents">
		<form:form modelAttribute="bookKeyword" action="gukboBookKeywordIndex.do" onsubmit="return false">
