				...
				<c:forEach items="${list}" var="i">
					<div class="list">
						<div class="thumb-image">
							<a href="/${homepage.context_path}/kiosk/gukboBookKeywordView.do?book_name=${i.bookname}&isbn=${i.isbn}&author=${i.author}&bookimgUrl=${empty i.bookimageURL ? '/resources/common/img/noImg2.png' : i.bookimageURL}">
