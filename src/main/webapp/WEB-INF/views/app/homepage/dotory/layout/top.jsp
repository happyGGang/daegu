		...
		<div class="main-section3">
			...
			<div class="util">
				<c:choose>
					...
					<c:otherwise>
						<a href="/${homepage.context_path}/intro/login/index.do?menu_idx=42" class="login">통합허브시스템 로그인</a>
						<span class="txt-bar"></span>
						<!-- <a href="/${homepage.context_path}/intro/join/integration.do?menu_idx=46">통합회원인증</a>
						<span class="txt-bar"></span> -->
						<a href="/${homepage.context_path}/intro/join/index.do?menu_idx=43">회원가입</a>
						<!-- <span class="txt-bar"></span>
