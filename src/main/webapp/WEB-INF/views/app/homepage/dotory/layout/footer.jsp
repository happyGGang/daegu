	...
	<div class="mFooter">
		<div class="middle">
			<div class="main-section">
				<div class="scroll-x">
					<div class="info">
						<a href="/${homepage.context_path}/html.do?menu_idx=48"><b>개인정보처리방침</b></a>
						<span class="barss">|</span>
						<a href="/${homepage.context_path}/html.do?menu_idx=49">영상정보처리방침</a>
						<span class="barss">|</span>
						<a href="/${homepage.context_path}/html.do?menu_idx=50">저작권보호정책</a>
					</div>
				</div>
				...
				<div class="address">
					...
					<p class="copyright">Copyright 2022. 꿈꾸는마을도서관 도토리 All Rights Reserved.</p>
				</div>
