							...
							<div class="box">
								<ul>
									<c:forEach items="${teachList}" var="i" varStatus="status">
										<li>
											<a href="/${homepage.context_path}/module/teach/detail.do?menu_idx=90&group_idx=${i.group_idx}&category_idx=${i.category_idx}&teach_idx=${i.teach_idx}&homepage_id=${i.homepage_id}">
								...
								<div class="bookList">
									<ul>
										<c:forEach items="${bookList1}" var="i" varStatus="status">
											<li class="item">
												<a href="/${homepage.context_path}/board/view.do?menu_idx=85&manage_idx=726&board_idx=${i.board_idx}">
													<c:choose>
