...
<link rel="stylesheet" type="text/css" href="/resources/homepage/gukbo/css/sub.css"/>
...
// 		$('div#menuRatingDiv').load('/gukbo/module/menuRating/index.do?menu_idx=${param.menu_idx}');
	}
...
<div id="wrap">
		...
		<div class="sub-visual">
			...
			<div class="doc-info">
				<div class="doc-title">
					...
					<ol>
						<li class="first"><a href="/gukbo/index.do"><img src="/resources/common/img/navi_home_icon.gif"></a></li>
	...
	<div id="foot_section">
		...
		<div class="home-up web-view">
				<a href="#top"><img src="/resources/homepage/gukbo/img/top-btn.png" alt="위로" class="homeup"></a>
		</div>

		<div class="home-up mobile-view">
			<img src="/resources/homepage/gukbo/img/top-btn.png" alt="위로" id="homeup-mobile">
		</div>
	</div>
