...
<div class="join-wrap">
	...
	<div>
		...
		<div class="Box" style="height:400px;">	
			<h5>2022 수성인문학제 독서릴레이 신청을 위한 개인정보 수집 및 이용 동의서</h5>
			<p>2022 수성인문학제 독서릴레이 신청을 위하여 아래와 같이 개인정보를 수집·이용하고자 합니다. 내용을 자세히 읽으신 후 동의 여부를 결정하여 주시기 바랍니다.</p>
			...
			<table class="tbl-type01 t_list tac" summary="개인정보 수집·이용 내역">
				...
				<tbody>
					<tr>
						...
						<td><u>2022 수성人문학제 사업 종료 시까지</u></td>
					</tr>
					<tr>
						<td colspan="4">
			...
			<p>만 14세 미만 아동의 개인정보를 처리하기 위하여 그 법정대리인의 동의를 받아야 합니다. 법정대리인의 최소한의 정보는 법정대리인의 동의없이 해당 아동으로부터 직접 수집할 수 있습니다.</p>
		</div>
