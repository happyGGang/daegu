...
<div class="join-wrap" style="padding: 0px !important;">
	...
	<div>
		...
		<div class="Box" style="height:400px;">	
			<h5>2021 수성人문학제 독서디베이트 공모를 위한 개인정보 수집 및 이용 동의서</h5>
			<p>2021 수성人문학제 독서디베이트 공모 신청을 위하여 아래와 같이 개인정보를 수집·이용하고자 합니다. 내용을 자세히 읽으신 후 동의 여부를 결정하여 주십시오.</p>
			...
			<table class="t_list tac" summary="개인정보 수집·이용 내역">
				...
				<tbody>
					<tr>
						...
						<td>독서디베이트 신청 및 운영, 홍보 및 기록자료(성과물)에 활용</td>
						<td>2021 수성人문학제 사업 종료 시까지</td>
					</tr>
					<tr>
						<td colspan="4">
							※ 독서디베이트 공모를 대상으로 활동사진 등 촬영하며, 본인의 초상이 사진 및 영상물 에 기록될 경우 수성구립(범어·용학·고산)도서관 행사홍보자료로 활용, 기록자료(성과집) 제작에 활용될 수 있습니다.<br/>
							※ 도서관의 독서·문화프로그램 홍보를 위하여 회원님의 연락처를 이용, 차후 행사관련 문자를 발송할 수 있습니다. 원치 않는 경우, 범어도서관(☎053-668-1600)으로 연락하시면 안전하게 파기하도록 하겠습니다.<br/>
							※ 위의 개인정보 수집·이용에 대한 동의를 거부할 권리가 있습니다.그러나 동의를 거부할 경우 독서디베이트 신청이 불가능합니다
						</td>
					</tr>
					<tr>
