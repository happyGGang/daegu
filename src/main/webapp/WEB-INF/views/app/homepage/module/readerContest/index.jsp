...
<form:hidden path="menu_idx"/>
  ...
  <ul class="con">
    ...
    <li>오프라인</li>
    <ul>
      <li class="dep01">기간 : 10.1.(목) ~ 10.31.(토)</li>
      <li class="dep01">방법 : 독서노트 방문제출(범어·용학·고산도서관)</li>
    </ul>
    <li>온라인</li>
    <ul>
      <li class="dep01">기간 : 6.2.(화) ~ 10.31.(토)</li>
      <li class="dep01">방법 : 책표지 사진, 서평 게재(@suseong_lib 게시물 참고)</li>
    </ul>
  </ul>
  <div class="sm_box02 note_img">
    ...
    <ul class="con">
      <li>[책자형]</li>
      <ul>
        <li class="dep01">배부기간 : 2020. 6. 2.(화) ~ 소진시</li>
        <li class="dep01">배부처 : 수성구립도서관(범어·용학·고산)</li>
        <li class="dep01">배부방법 : 독서릴레이 신청서 작성(홈페이지) → 방문수령</li>
      </ul>
      <li>[웹형]</li>
      <ul>
        <li class="dep01">인스타그램(@suseong_lib) 게시물 확인 → 책표지 사진 포함 서평작성(#수성문학제#수성북#독서릴레이 태그 후 게재)</li>
      </ul>
    </ul>
  </div>
  <h3>시상</h3>
  <ul class="con">
    <li>발표 : 2020년 11월 중 개별통보 및 홈페이지 발표
    <li>시상 : 2020년 12월 예정
    <li>시상내역</li>
  </ul>
  ...
  <div class="auto-scroll">
    <table class="tbl-type01" summary="다독자 공모 시상내역을 나타내는 표">
      ...
      <thead>
        <tr>
          <th scope="col">등급/대상</th>
          <th scope="col">소년부(초등~중등)</th>
          <th scope="col">장년부(고등~일반) </th>
          <th scope="col">상품</th>
        </tr>
      </thead>
      <tbody>
  ...
  <ul class="con">
    <li class="bg_none" style="padding:10px 0 2px;">※ 상품금액에 의한 재세공과금 본인 부담</li>
