...
function hans_read(url) {
	var features = 'width=1120,height=710,scrollbars=yes';
	var popupPlayer = window.open(url, "HANS", features);
	if (popupPlayer == null) {
...
function cont_read(url) {
	...
	var popupPlayer = window.open(url, "CONT", 'width='+width+',height='+height+',scrollbars=yes');
	if (popupPlayer == null) {
		alert("팝업 차단 기능이 설정되어있습니다\n\n차단 기능을 해제(팝업허용) 한 후 다시 이용해 주십시오.\n\n팝업 차단 기능을 해제하지 않으면\n정상적인 전자책을 이용하실 수 없습니다.\n\n* 차단 해제 방법 \n설정 - 인터넷 옵션 - 개인정보 - 팝업차단 설정\n허용할 웹 사이트 주소 : *.daegu.go.kr 추가");
		return false;
	}
...
function cont2_read(url) {
	...
	var popupPlayer = window.open(url, "CONT2", dimension+',scrollbars=yes');
	if (popupPlayer == null) {
		alert("팝업 차단 기능이 설정되어있습니다\n\n차단 기능을 해제(팝업허용) 한 후 다시 이용해 주십시오.\n\n팝업 차단 기능을 해제하지 않으면\n정상적인 전자책을 이용하실 수 없습니다.\n\n* 차단 해제 방법 \n설정 - 인터넷 옵션 - 개인정보 - 팝업차단 설정\n허용할 웹 사이트 주소 : *.daegu.go.kr 추가");
		return false;
	}
...
function glob_read(url) {
	var popupPlayer = window.open(url, "GLOB", 'width=710,height=527,scrollbars=yes');
	if (popupPlayer == null) {
		alert("팝업 차단 기능이 설정되어있습니다\n\n차단 기능을 해제(팝업허용) 한 후 다시 이용해 주십시오.\n\n팝업 차단 기능을 해제하지 않으면\n정상적인 전자책을 이용하실 수 없습니다.\n\n* 차단 해제 방법 \n설정 - 인터넷 옵션 - 개인정보 - 팝업차단 설정\n허용할 웹 사이트 주소 : *.daegu.go.kr 추가");
		return false;
	}
...
function ybmn_read(url) {
	var popupPlayer = window.open(url, "YBMN", 'width=835,height=650,scrollbars=yes');
	if (popupPlayer == null) {
		alert("팝업 차단 기능이 설정되어있습니다\n\n차단 기능을 해제(팝업허용) 한 후 다시 이용해 주십시오.\n\n팝업 차단 기능을 해제하지 않으면\n정상적인 전자책을 이용하실 수 없습니다.\n\n* 차단 해제 방법 \n설정 - 인터넷 옵션 - 개인정보 - 팝업차단 설정\n허용할 웹 사이트 주소 : *.daegu.go.kr 추가");
		return false;
	}
			...
			<div class="sinfo">
				...
				<div class="info">
					<ul>
						...
						<li>대출 가능 여부: ${fn:escapeXml(book.status)}<span class="txt-bar">&nbsp;</span>대출 : ${fn:escapeXml(book.book_lend)}/${book.max_lend > 0 ? book.max_lend : bookConfig.book_max_lend}<%-- / ${fn:escapeXml(book.max_lend)}--%><span class="txt-bar">&nbsp;</span>예약 : ${fn:escapeXml(book.book_reserve)}/${bookConfig.book_max_reserve}<span class="txt-bar">&nbsp;</span>조회수 : ${fn:escapeXml(book.view_count)}</li>
