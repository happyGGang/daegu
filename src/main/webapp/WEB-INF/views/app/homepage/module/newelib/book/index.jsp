			...
			<table class="bestbook_l_table">
				<tr>
					<c:forEach items="${categoryBestBookList}" var="i" varStatus="status">
						<td>
							<span class="num">${status.index+1}</span><span class="book"><a href="/newelib/module/newelib/book/view.do?menu_idx=15&menu=BEST&type=EBK&book_idx=${i.book_idx}"><img src="${i.book_image}" alt="${fn:escapeXml(i.book_name)}"/></a></span>
						</td>
					</c:forEach>
				</tr>
			</table>
