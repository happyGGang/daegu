...
<form:form modelAttribute="walkingThruRecord" method="POST" action="index.do">
<form:hidden id="homepage_id" path="homepage_id"/>
<form:hidden path="menu_idx"/>
<div class="book-list" style="border-top:none;">

	<c:if test="${fn:length(walkingThruRecordList) < 1 }"> <h3 style="margin-top:0;">워킹스루 도서대출 내역이 없습니다.</h3></c:if>
