...
$(function() {
	$('#save-btn').on('click', function(e) {
		...
		<c:if test="${fn:contains(walkingThruSetting.terms, i.terms_idx)}">
		...
		if (!confirm('워킹스루 도서대출 예약 신청을 하시겠습니까?\n도서연체시 대출불가')) {
			return false;
		}
...
<div id="contents-title">
	<h2>워킹스루 도서대출 예약 신청을 위한 신청사항<span style="font-weight:300">을 확인하세요.</span></h2>
</div>
<br>
...
<div class="delibery_info">
	...
	<div id="" class="" style="text-align: center; padding-top: 15px;">
		<p style="color: red;font-weight: bold;">* 도서연체중에는 워킹스루 도서대출 예약 불가 (본인 대출상태 확인필요)</p>
	</div>
