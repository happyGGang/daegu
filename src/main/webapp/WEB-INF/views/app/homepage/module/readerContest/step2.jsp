...
$(function() {
	...
	$('a#join-btn').on('click', function(e) {
		...
		if ( $('input[name="agree_codes"][req="0001"]:checked').length == $('input[name="agree_codes"][req="0001"]').length ) {
			doGetLoad('edit.do', serializeCustom($('form#readerContestStep')));
		} else {
...
<div class="join-wrap" style="padding: 0px !important;width:970px;">
	...
	<div>
		...
		<div class="Box" style="height:400px;">	
			<h5>2022 수성인문학제 다독자 공모를 위한 개인정보 수집 및 이용 동의서</h5>
			<p>2022 수성인문학제 다독자 공모 신청을 위하여 아래와 같이 개인정보를 수집·이용하고자 합니다.<br />내용을 자세히 읽으신 후 동의 여부를 결정하여 주십시오.</p>
			...
			<table class="tbl-type01 t_list tac" summary="개인정보 수집·이용 내역">
				...
				<tbody>
					<tr>
						<td style="text-align:center;">성명, 연락처(휴대전화), E-mail,<br />주소, 활동사진·영상</td>
						<td style="text-align:center;">공모전 신청 및 운영,<br />홍보 및 기록자료(성과물)에 활용</td>
						<td style="text-align:center;">2022 수성인문학제 사업 종료 시까지</td>
					</tr>
				</tbody>
			</table>
			<br/>

			<p style="text-align:left;">※ 공모전 참여자를 대상으로 활동사진 등 촬영하며, 본인의 초상이 사진 및 영상물에 기록될 경우<br />　&nbsp;       수성구립도서관(범어·용학·고산) 행사 홍보자료로 활용, 기록자료(자료집) 제작에 활용될 수 있습니다.<br />
			※ 도서관의 독서·문화프로그램 홍보를 위하여 회원님의 연락처를 이용, 차후 행사관련 문자를 발송할 수 있습니다.<br />　&nbsp;       원치 않는 경우, 범어도서관(☎053-668-1600)으로 연락하시면 안전하게 파기하도록 하겠습니다.<br />
			※ 위의 개인정보 수집·이용에 대한 동의를 거부할 권리가 있습니다.<br />　&nbsp;       그러나 동의를 거부할 경우 공모전 신청이 불가능합니다.</p>				
			<br/>
			...
			<p>만 14세 미만 아동의 개인정보를 처리하기 위하여 그 법정대리인의 동의를 받아야 합니다.<br />법정대리인의 최소한의 정보는 법정대리인의 동의 없이 해당 아동으로부터 직접 수집할 수 있습니다.</p>
		</div>
