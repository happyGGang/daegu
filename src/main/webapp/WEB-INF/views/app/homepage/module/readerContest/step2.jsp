...
<div class="join-wrap" style="padding: 0px !important;">
	...
	<div>
		...
		<div class="Box" style="height:400px;">	
			<h5>2020 수성人문학제 다독자 공모를 위한 개인정보 수집 및 이용 동의서</h5>
			<p>2020 수성人문학제 다독자 공모 신청을 위하여 아래와 같이 개인정보를 수집·이용하고자 합니다. 내용을 자세히 읽으신 후 동의 여부를 결정하여 주십시오.</p>
			...
			<table class="t_list tac" summary="개인정보 수집·이용 내역">
				...
				<tbody>
					...
					<tr>
						<td colspan="4">
							※ 독서릴레이 참여자를 대상으로 활동사진 등 촬영하며, 본인의 초상이 사진 및 영상물 에 기록될 경우 수성구립(범어·용학·고산)도서관 행사홍보자료로 활용, 기록자료(성과집) 제작에 활용될 수 있습니다.<br/>
