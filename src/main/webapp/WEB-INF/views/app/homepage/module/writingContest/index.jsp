...
$(function() {
	...
	$('a#join-btn').on('click', function(e) {
		...
		if ( $('input[name="agree_codes"][req="0001"]:checked').length == $('input[name="agree_codes"][req="0001"]').length ) {
			doGetLoad('edit.do', serializeCustom($('form#writingContest')));
		} else {
...
<form:form modelAttribute="writingContest" id="writingContest" action="edit.do" >
	...
	<div class="join-wrap" style="padding: 0px !important;width:970px;">
		...
		<div class="Box" style="height:400px;">	
			<h5>2020 수성人문학제 백일장 참가 신청을 위한 개인정보 수집 및 이용 동의서</h5>
			<p>2020 수성人문학제 백일장 참가 신청을 위하여 아래와 같이 개인정보를 수집·이용하고자 합니다. 내용을 자세히 읽으신 후 동의 여부를 결정하여 주십시오.</p>
			...
			<table class="t_list tac" summary="개인정보 수집·이용 내역">
				...
				<tbody>
					<tr>
						...
						<td>백일장 참가 신청, 홍보 및 기록자료(성과물)에 활용</td>
