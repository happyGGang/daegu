...
<form:form modelAttribute="bookReportClub" id="bookReportClubEdit" action="save.do" method="POST" enctype="multipart/form-data">
	...
	<div class="wrapper-bbs" style="padding-top:0;">
		...
		<table class="bbs-edit" summary="독후감 공모 참가 신청">
			...
			<tbody id="board_tbody">
				...
				<tr>
					<th>대표자명<b style="color: red;">(*)</th>
					<td>
						<form:input path="rep_name" cssClass="text" />
					</td>
				</tr>
				<tr>
					<th>휴대폰(제1 연락처)<b style="color: red;">(*)</b></th>
					<td>
