...
<style>
	...
	.event_all .event01{position:relative;padding-top:61px;margin-bottom:150px;}
	...
	.event_all .event01 em{position:absolute;right:0;top:60px;font-size: 17px;font-family: 'Roboto','NotoKrB';font-weight: bold;color:#222;letter-spacing: 0;font-style: normal;}
</style>
<h2 style="background: 0;">종목별 현황</h2>
<c:choose>
