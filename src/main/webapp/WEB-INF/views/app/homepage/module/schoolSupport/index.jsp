...
<form:hidden id="homepage_id_1" path="homepage_id"/>
	...
	<div class="ym_btns">
		...
		<form:select path="plan_year" title="년도" class="" style="width:80px;height:28px;"></form:select>
		<form:select path="plan_month" title="월" class="" style="width:65px;height:28px;"></form:select>
