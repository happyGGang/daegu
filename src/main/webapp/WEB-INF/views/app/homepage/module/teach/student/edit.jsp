...
// 			}
			...
			if ($('#self_yn1').is(':checked')) {
				...
				<c:if test="${teach.getFamily_count_yn eq 'Y'}">
				var student_family_count = $form.find('#student_family_count').val();
				if (student_family_count == '') {
					$form.find('#student_family_count').focus();
					alert('가족인원수를 입력해주세요.');
					doubleSubmit = false;
					return false;
				}
