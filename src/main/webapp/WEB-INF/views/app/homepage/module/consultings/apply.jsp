...
$(function() {
	...
	$('a#delete-btn').on('click', function(event) {
		if(confirm("해당 신청내역을 삭제 하시겠습니까?\n삭제된 데이터는 복구가 불가합니다.")) {
			$.ajax({
				url : '/${homepage.context_path}/module/consultings/save.do?editMode=DELETE&apply_idx=' + $(this).attr("keyValue") + '&homepage_id=' + $('#homepage_id').val(),
				async : false,
				method : 'POST',
...
<form:form modelAttribute="consultingApply" id="applyEdit" action="/${homepage.context_path}/module/consultings/save.do" method="post">
