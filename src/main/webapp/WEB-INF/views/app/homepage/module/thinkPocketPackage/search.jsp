...
<style>
  .serial-wrap .search-results .row .item a.name {
    font-weight: 800;
    font-size: 140%;
                    ...
                    <c:forEach items="${naverResult.list}" var="i" varStatus="status">
                        <div class="row">
                            ...
                            <div class="box">
                                <div class="item">
                                    <div class="bif">
                                        <a href="#" class="name" target="_blank" style="cursor: default;" onclick="return false;" alt="${i.title}" title="${i.title}">${fn:substring(i.title, 0, 30)}<c:if
                                                test="${fn:length(i.title) > 30}">...</c:if></a>
                                        <ul class="con2">
                                            ...
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <li class="button" style="background: none;">
                                                        ...
                                                        <span data="${i.title}//${i.author}//${i.publisher}//${fn:substring(i.pubdate,0,4)}//${i.isbn13}//${i.price}//${i.description}//${i.link}//${i.image}"></span>
                                                    </li>
                                                </c:otherwise>
                                            </c:choose>
                                        </ul>
