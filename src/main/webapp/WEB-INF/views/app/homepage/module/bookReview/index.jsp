...
.starR2 {position: relative;display: inline-block;right: 18px;width: 28px;height: 23.5px;background: url("/resources/common/img/ico_star.png") no-repeat;background-size: 25px;margin-right: -25px;}
