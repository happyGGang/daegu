...
<script type="text/javascript">
    jQuery("#gcDiv").qrcode({   //qrcode 시작
        ...
        width : 350,            //넓이 조절
        height : 350,           //높이 조절
        text   : "${untactBookReservation.rec_key}"+"^"+"${untactBookReservation.homepage_id}"+"^"+"${untactBookReservation.locker_number}"+"^"+"${untactBookReservation.locker_password}"     //QR코드에 실릴 문자열
    });
</script>
<div id="gcDiv"></div>