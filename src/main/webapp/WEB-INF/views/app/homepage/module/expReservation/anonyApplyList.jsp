...
$(function() {
	...
	$('a#search-btn').on('click', function(e) {
		...
		form.setAttribute("action", "anonyApplyList.do");
		
		var hiddenField1 = document.createElement("input");
		hiddenField1.setAttribute("type", "hidden");
		hiddenField1.setAttribute("name", "menu_idx");
		hiddenField1.setAttribute("value", $('#menu_idx').val());
		form.appendChild(hiddenField1);
		
		var hiddenField2 = document.createElement("input");
		hiddenField2.setAttribute("type", "hidden");
		hiddenField2.setAttribute("name", "searchCheck");
		hiddenField2.setAttribute("value", "yes");
		form.appendChild(hiddenField2);
		
		var hiddenField3 = document.createElement("input");
		hiddenField3.setAttribute("type", "hidden");
		hiddenField3.setAttribute("name", "searchDateFrom");
		hiddenField3.setAttribute("value", $('#searchDateFrom').val());
		form.appendChild(hiddenField3);
		
		var hiddenField4= document.createElement("input");
		hiddenField4.setAttribute("type", "hidden");
		hiddenField4.setAttribute("name", "searchDateTo");
		hiddenField4.setAttribute("value", $('#searchDateTo').val());
...
<input type="hidden" name="searchCheck" value="yes"/>
	...
	<c:if test="${fn:length(expAnonyApplyUserList) <1 }">
	...
	<div class="op_wrap">
		<div class="smain">
			<c:forEach items="${expAnonyApplyUserList}" var="i">
				<div class="item">
