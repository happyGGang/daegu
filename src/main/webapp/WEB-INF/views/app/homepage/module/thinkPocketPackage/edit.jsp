...
<script type="text/javascript">
  ...
  $(function () {
    ...
    $('#cancel-btn').on('click', function (e) {
      e.preventDefault();
      var formData = 'menu_idx=' + $('#menu_idx').val() + '&viewPage=' + $('#viewPage').val();
    ...
    if ('${thinkPocketPackage.image_link}' == '') {
      $('#thumbnail').hide();
    } else {
      $('#thumbnail td').html('<img src="${thinkPocketPackage.image_link}" alt="${thinkPocketPackage.think_pocket_package_subject}">');
    }
