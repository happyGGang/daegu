...
<div class="tnb">
	<div class="" >
		<h1 class='web-logo'><a href="/${homepage.context_path}/index.do"><img src="/resources/homepage/${homepage.context_path}/img/${homepage.context_path}_logo.png" alt="대구광역시전자도서관"/></a></h1>
