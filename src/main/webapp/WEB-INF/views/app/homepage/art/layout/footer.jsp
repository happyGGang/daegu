	...
	<div class="mFooter">
		<div class="middle">
			<div class="main-section">
				<div class="scroll-x">
					<div class="info">
						<a href="/${homepage.context_path}/html.do?menu_idx=66"><b>개인정보처리방침</b></a>
						<span class="barss">|</span>
						<a href="/${homepage.context_path}/html.do?menu_idx=67">영상정보처리방침</a>
						<span class="barss">|</span>
						<a href="/${homepage.context_path}/html.do?menu_idx=68">저작권보호정책</a>
					</div>
				</div>
				...
				<div class="address">
					...
					<p class="copyright">Copyright 2022. 아트도서관 All Rights Reserved.</p>
				</div>
