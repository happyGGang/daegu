			...
			<div class="util">
				<c:choose>
					<c:when test="${sessionScope.member.loginType eq 'PRIVATEHOMEPAGE' and sessionScope.member.login}">
						...
						<span class="txt-bar"></span>
						<a href="/${homepage.context_path}/intro/join/modifyCheck.do?menu_idx=73">정보수정</a>
					</c:when>
					...
					<c:otherwise>
						<a href="/${homepage.context_path}/intro/login/index.do?menu_idx=60" class="login">통합허브시스템 로그인</a>
						<span class="txt-bar"></span>
						<!-- <a href="/${homepage.context_path}/intro/join/integration.do?menu_idx=64">통합회원인증</a>
						<span class="txt-bar"></span> -->
						<a href="/${homepage.context_path}/intro/join/index.do?menu_idx=61">회원가입</a>
						<!-- <span class="txt-bar"></span>
