...
<c:if test="${not empty closeDayList.dd}">
	...
	<div class="close_day">휴관일</div>
	<div class="week_navigation">
		<img id="before-btn" src="/resources/homepage/center/img/closed_day_arrow.svg" alt="지난주" role="button" keyValue="${calendar.plan_date}"/>
		<div class="date">${fn:split(calendar.plan_date, '-')[1]}년 ${fn:split(calendar.plan_date, '-')[0]}월</div>
		<img id="next-btn" src="/resources/homepage/center/img/closed_day_arrow.svg" alt="다음주" role="button" keyValue="${calendar.plan_date}"/>
	</div>
	<ul class="week_area">
