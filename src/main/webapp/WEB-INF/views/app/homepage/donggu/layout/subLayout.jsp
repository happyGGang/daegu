									...
									<div id="share_layer">
										<div class="shareAllBtns" >
											<ul class="shareBox">
												...
												<li><a href="" class="sub-twitter" keyValue1="${homepage.homepage_id}" keyValue2="${menuOne.menu_idx}" keyValue3="${menuOne.menu_name}" keyValue4="${homepage.homepage_name}"><img src="/resources/common/img/sns_x_btn.png" alt="${homepage.homepage_name} X로 공유하기" class="shareIcon" style="padding-left:3px;padding-right:3px;margin:0"></a></li>
