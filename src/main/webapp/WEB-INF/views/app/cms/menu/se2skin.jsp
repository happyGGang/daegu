...
<link href="/resources/cms/smart_editor/css/smart_editor2.css" rel="stylesheet" type="text/css">
<style type="text/css">
	body { margin: 10px; }
	.se2_to_text { display: none !important; }
</style>
<script type="text/javascript" src="/resources/cms/smart_editor/js/jindo.min.js" charset="utf-8"></script>
<script type="text/javascript" src="/resources/cms/smart_editor/js/jindo_component.js" charset="utf-8"></script>
<script type="text/javascript" src="/cms/menu/${contextPath}/se2configuration_general.do" charset="utf-8"></script>	<!-- 설정 파일 -->
<script type="text/javascript" src="/resources/cms/smart_editor/js/SE2B_Configuration_General.js" charset="utf-8"></script>	<!-- 설정 파일 -->
<script type="text/javascript" src="/resources/cms/smart_editor/js/SE2BasicCreator.js" charset="utf-8"></script>

<script src='/resources/cms/smart_editor/js/smarteditor2_1_menuHtml.min.js' charset='utf-8'></script>
<script src='/resources/cms/smart_editor/photo_uploader/plugin/hp_SE2M_AttachQuickPhoto_menuHtml.js' charset='utf-8'></script>
<script src='/resources/cms/smart_editor/photo_uploader/plugin/hp_SE2M_ShowHistory_menuHtml.js' charset='utf-8'></script>
</head>
<body>
	...
	<div id="smart_editor2_content"><a href="#se2_iframe" class="blind">글쓰기영역으로 바로가기</a>
		<div class="se2_tool" id="se2_tool">
			...
			<ul class="se2_font_type">
				...
				<ul>
					<li class="se2_mn husky_seditor_ui_show_history"><button type="button" class="se2_show_history ico_btn"><span class="se2_icon"></span><span class="se2_mntxt _buttonRound">히스토리<span class="se2_new"></span></span></button></li>
				</ul>
				<ul class="se2_multy">
		...
		<hr>
		<!-- 입력 -->
		<div class="se2_input_area husky_seditor_editing_area_container" style="width:100% !important;">

			<iframe src="about:blank" id="se2_iframe" name="se2_iframe" class="se2_input_wysiwyg" height="300" title="글쓰기 영역 : 도구 모음은 ALT+F10을, 도움말은 ALT+0을 누르세요." frameborder="0" style="display:block;"></iframe>
		...
		<div class="se2_conversion_mode">
			...
			<li><button type="button" class="se2_to_editor"><span>Editor</span></button></li>
			<li class="active"><button type="button" class="se2_to_html"><span>HTML</span></button></li>
