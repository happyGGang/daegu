                            ...
                            <c:forEach items="${statusList}" var="i">
                                <th scope="col" class="btw">
                                    ...
                                    <div>
                                        ...
                                        <a href="#" class="btn status-del" keyValue="${i.status_idx}"
                                           keyValue2="${i.division_idx}">삭제</a>
                                    </div>
                                </th>
                            </c:forEach>
                        </tr>
                    ...
                    <c:forEach items="${workList}" var="j">
                        <c:if test="${i.organization_idx eq j.organization_idx}">
                            <tr>
                                ...
                                <td>${j.phone}</td>
                                <td>
                                    <a href="#" class="custom-btn" id="dialog-modify"
                                       keyValue="${j.organization_work_idx}">수정</a>
                                    <a href="#" class="custom-btn" id="delete"
                                       keyValue="${j.organization_work_idx}">삭제</a>
                                </td>
                            </tr>
                        </c:if>
                    </c:forEach>
