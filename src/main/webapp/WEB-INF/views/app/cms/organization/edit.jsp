		...
		buttons: [
			{
				...
				"class": 'btn btn1',
				click: function() {
					if(doAjaxPost($('form#organizationWorkEdit'))) {
						location.reload();
					}
				}
			},{
...
// 					location.reload();
	...
	$('select#organization_idx').select2();
});
</script>
<style type="text/css">
...
<form:form modelAttribute="organization" id="organizationWorkEdit" action="save.do" method="POST">
	<form:hidden path="homepage_id"/>
	<form:hidden path="editMode"/>
	<form:hidden path="organization_work_idx"/>
	<table class="type2">
		<colgroup>
			<col width="130"/>
			<col width="*"/>
		...
		<tbody>
			<tr>
				<th>부 서</th>
				<td>
					<form:select path="organization_idx" cssClass="selectmenu-search" cssStyle="width:146px;">
