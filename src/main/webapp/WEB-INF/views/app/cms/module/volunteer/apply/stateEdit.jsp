		...
		buttons: [
			{
				...
				click: function() {
					if(doAjaxPost($('#applye_state'))) {
						$(this).dialog('destroy');
						$('#dialog-3').load('/cms/module/volunteer/apply/applyEdit.do?editMode=ADD&homepage_id=' + $('#homepage_id_1').val() + '&volunteer_idx=${apply.volunteer_idx}&start_date=${apply.start_date}');
					}
				}
			},{
				text: "취소",
...
<form:form modelAttribute="volunteerApply" id="applye_state" method="post" action="/cms/module/volunteer/apply/save.do">
