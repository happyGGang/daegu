...
//             $(this).attr({ 'download': filename, 'href': csvData, 'target': '_blank' });
  ...
  $(function() {
    ...
    $('a#csvDownload').on('click', function(e) {
      ...
      var csv = exportTableToCSV(data_table,'구분,공급사,소장자료수,PC VIEWER 열람수,Android,iOS,(구 스마트폰 VIEWER 열람수),스마트폰 합계,기타(불명) VIEWER 열람수,소계');
      $('#csv_string').val(csv);
      $('#csv_filename').val('전자도서관_VIEWER 열람수별통계_'+formatDate(new Date())+'.csv');
      $('#csvForm').submit();
    });
...
<form id="csvForm" method="POST" action="index_csv.do">
    ...
    <input type="hidden" id="csv_filename" name="filename" value="전자도서관_VIEWER 열람수별통계.csv">
</form>
<form:form id="elibStatisticsListForm"  modelAttribute="elibStatistics" action="index.do" >
    ...
    <jsp:include page="/WEB-INF/views/app/cms/module/elib/statistics/viewer_included.jsp" flush="false"/>
</form:form>
