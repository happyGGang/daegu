		...
		buttons: [
			{
				...
				"class": 'btn btn1',
				click: function() {					
					if(doAjaxPost($('#showPerformance_edit'))) {
						$(this).dialog('destroy');
						location.reload();
					}
				}
...
<form:form modelAttribute="showPerformance" id="showPerformance_edit" action="save.do" method="post" onsubmit="return false;">
<form:hidden path="editMode"/>
<form:hidden path="plan_date" value="${fn:substring(calendarManage.start_date,0,7)}"/>
<form:hidden path="homepage_id"/>
<form:hidden path="showPerformance_idx"/>
...
<table class="type2">
	...
	<tbody>
		...
		<tr>
			<th>공연가능 일자(<span style="color: red; font-weight: bold;">*</span>)</th>
				<td>
					...
					<c:if test="${showPerformance.editMode eq 'ADD'}">
		...
		<tr>
			<th>공연시간(<span style="color: red; font-weight: bold;">*</span>)</th>
			<td>
				...
				<div class="ui-state-highlight">
					<em>* 공연 시간 입력 ex) 10:30</em>
				</div>			
			</td>
		</tr>
		<tr>
			<th>공연신청기간(<span style="color: red; font-weight: bold;">*</span>)</th>
			<td>
