		...
		buttons: [
			{
				...
				click: function() {
					if(doAjaxPost($('#applye_state'))) {
						$(this).dialog('destroy');
						$('#dialog-3').load('/cms/module/showPerformance/apply/applyEdit.do?editMode=ADD&homepage_id=' + $('#homepage_id_1').val() + '&showPerformance_idx=${showApply.showPerformance_idx}&start_date=${showApply.start_date}');
					}
				}
			},{
				text: "취소",
...
<form:form modelAttribute="showApply" id="applye_state" method="post" action="/cms/module/showPerformance/apply/save.do">
...
<form:hidden path="applicant_tel"/>
	...
	<tbody>
		<tr>
			<th>신청 기관명</th>
			<td>
				<form:input path="agency_name" maxlength="10" cssClass="text" cssStyle="width:100px;" readonly="true"/>
			</td>
		</tr>
		<tr>
			<th>승인상태</th>
