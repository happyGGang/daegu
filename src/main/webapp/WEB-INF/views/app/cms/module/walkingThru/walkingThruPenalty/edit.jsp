		...
		buttons: [
			{
				...
				click: function() {
					...
					var option = {
						url : 'save.do',
						type : 'POST',
						data : $('#walkingThruPenaltyForm').serialize(),
					...
					$('#walkingThruPenaltyForm').ajaxSubmit(option);
				}
			},{
				text: "취소",
				"class": 'btn',
...
<form:form modelAttribute="walkingThruPenalty" id="walkingThruPenaltyForm" action="save.do" method="POST" onsubmit="return false;">
