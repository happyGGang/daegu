...
<ul>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;<a href="//library.daegu.go.kr/newelib/module/newelib/set.do?debug=true">https://library.daegu.go.kr/newelib/module/newelib/set.do?debug=true</a> 를 열면<br/>
	&nbsp;&nbsp;&nbsp;&nbsp;현 세션이 일시적으로 미승인 자료만 열람 가능한 상태가 된다.<br/>
	&nbsp;&nbsp;&nbsp;&nbsp;(취소는 <a href="//library.daegu.go.kr/newelib/module/newelib/set.do?debug=false">https://library.daegu.go.kr/newelib/module/newelib/set.do?debug=false</a>)
	</li>
