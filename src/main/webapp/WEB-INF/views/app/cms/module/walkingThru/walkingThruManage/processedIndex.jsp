...
$(function(){
	$('button#search_btn').on('click', function(e) {
		e.preventDefault();
		$('#viewPage').val(1);
		doGetLoad('processedIndex.do', $('form#walkingThruRecord').serialize());
	});
...
function waitingReservationStep() {
	if($('input:checkbox[name=request_number_arr]:checked').length < 1) {
		...
		if(confirm('대기처리 하시겠습니까?')) {
			$.ajax({
				type: "POST",
				url: 'waitingReservationStepBefore.do',
...
<div class="tab">
	<ul class="tabnav">
		<li><a href="/cms/module/walkingThru/walkingThruManage/index.do" style="font-size: 13px;">신청 항목</a></li>
		<li><a href="/cms/module/walkingThru/walkingThruManage/processedIndex.do" class="active" style="font-size: 13px;">대기,대출 처리 항목</a></li>
