		...
		buttons: [
			{
				...
				click: function() {
					if(doAjaxPost($('#applye_state'))) {
						$(this).dialog('destroy');
						$('#dialog-3').load('/cms/module/consultings/apply/applyEdit.do?editMode=ADD&homepage_id=' + $('#homepage_id_1').val() + '&consultings_idx=${apply.consultings_idx}&start_date=${apply.start_date}');
					}
				}
			},{
				text: "취소",
...
<form:form modelAttribute="consultingApply" id="applye_state" method="post" action="/cms/module/consultings/apply/save.do">
