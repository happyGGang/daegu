...
<%
	...
	MarathonApplicant marathonApplicant = (MarathonApplicant)request.getAttribute("marathonApplicant");
	String filename = "일지_" + marathonApplicant.getMember_name() + "_" + today + ".xls";
...
%>
	...
	<table style="margin-top:3%;font-size:15px;padding:5px 5px">
		<tr>
			<th colspan="2" style="width:250px;text-align:left;">아이디</th>
		...
		<tr>
			<td rowspan="2" colspan="2">${marathonApplicant.member_id}</td>
			...
			<td rowspan="2" colspan="2"><fmt:formatDate value="${marathonApplicant.finish_date}" pattern="yyyy-MM-dd HH:mm"/></td>
			<td> </td>
		</tr>
		<tr>
