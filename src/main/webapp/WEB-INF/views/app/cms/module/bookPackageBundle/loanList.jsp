...
$(function() {
	...
	$('a.dialog-edit').on('click', function(e) {
		e.preventDefault();
		$('#dialog-2').load('loanEdit.do?editMode=MODIFY&book_package_bundle_loan_idx='+$(this).attr('keyValue'), function(response, status, xhr) {
		...
		<tbody>
			<c:forEach var="i" varStatus="status" items="${loanList}">
				<tr>
					...
					<td class="left">
						<a href="#" class="dialog-edit" keyValue="${i.book_package_bundle_loan_idx}">
							${i.book_package_bundle_title}
							<br/>
