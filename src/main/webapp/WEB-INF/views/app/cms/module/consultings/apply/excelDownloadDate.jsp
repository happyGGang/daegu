...
$(function() {
	...
	$('a#excelDownload').on('click', function(event) {
		...
		$('#excelDownloadMonthDate').attr('action','/cms/module/consultings/apply/excelDownloadMonth.do?editMode=default').submit();
	});
	...
	$('a#excelDownload2').on('click', function(event) {
		...
		$('#editMode').val("select");
		$('#excelDownloadMonthDate').attr('action','/cms/module/consultings/apply/excelDownloadMonth.do?editMode=select').submit();
	});
	
	
});
</script>	
<form:form modelAttribute="consultingApply" id="excelDownloadMonthDate" action="/cms/module/consultings/apply/excelDownloadMonth.do">
