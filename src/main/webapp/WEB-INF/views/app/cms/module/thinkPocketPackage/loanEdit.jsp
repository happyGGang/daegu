		...
		buttons: [
			{
				...
				"class": 'btn btn1',
				click: function() {
					if(doAjaxPost($('#thinkPocketPackageLoan'))) {
						location.reload();
					}
				}
			},{
...
<form:form id="thinkPocketPackageLoan" modelAttribute="thinkPocketPackage" action="loanSave.do" method="POST">
	...
	<form:hidden path="think_pocket_package_loan_idx" id="think_pocket_package_loan_idx_u"/>
			...
			<tr>
				...
				<td>
					<form:select path="request_status" cssClass="selectmenu">
						...
						<form:option value="2">대출처리</form:option>
