...
$(function() {
	...
	$('a.idCheck').on('click', function(e) {
		...
		$.get('/cms/module/showPerformance/apply/checkId.do?homepage_id=' + $('#homepage_id').val() + '&applicant_member_id='+ $('#applicant_member_id').val() + '&search_api_type=' + $('#search_api_type').val(), function(response) {
...
<form:form modelAttribute="showApply" id="apply_edit" action="/cms/module/showPerformance/apply/save.do" method="post" onsubmit="return false;">
...
<table class="type2">
	...
	<tbody>
		...
		<tr>
         	...
         	<td>
         		<c:choose>
         			<c:when test="${showApply.editMode eq 'ADD' }">
		...
		<tr>
			...
			<td>
				<form:input path="agency_address" class="text" cssStyle="width:60%"/><button class="btn btn2 findPostCode" keyValue1="#applicant_zipcode" keyValue2="#applicant_agency_address" keyValue3="#age">주소 찾기</button>
			</td>
		</tr>
		<tr>
			<th>관람인원(<span style="color: red; font-weight: bold;">*</span>)</th>
			<td>
				총인원<form:input path="total_peple" type="text" class="form-control num_only num_comma num_sum"	id="total" name="total"	cssStyle="width:25px" maxlength="3" readonly="true"/>명</br>
