...
<form:form id="eventForm" modelAttribute="event" method="post" action="save.do" >
		...
		<colgroup>
       	...
       	<tbody>
       		...
       		<tr>
	         	<th>이벤트구분</th>
	         	<td>
	         		<form:select path="event_type" class="text selectmenu">
	        ...
	        <tr>
	         	<th>이벤트연도</th>
	         	<td><form:input path="event_year" class="text" cssStyle="width:50px;"/> 년 <form:input path="event_month" class="text" cssStyle="width:50px;"/> 월</td>
	        </tr>
	        <tr>
	         	<th>이벤트참여기간</th>
	         	<td><form:input path="event_start_date" cssClass="text ui-calendar"/> ~ <form:input path="event_end_date" cssClass="text ui-calendar"/></td>
	        </tr>
	        <tr>
	         	<th>이벤트제목</th>
	         	<td><form:input path="event_name" class="text" cssStyle="width:100%"/></td>
	        </tr>
	        <tr>
	        	<th>학교 입력여부</th>
	        	<td>
			...
			<tr>
				<th>아이디 입력 여부</th>
				<td>
					<form:radiobutton path="applicant_id_yn"  value="N" label="아니오"/>
					<form:radiobutton path="applicant_id_yn"  value="Y" label="예"/>
				</td>
			</tr>
			<tr>
				<th>주소 입력 여부</th>
				<td>
					<form:radiobutton path="address_yn"  value="N" label="아니오"/>
