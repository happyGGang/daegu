...
$(function() {
	...
	$('a.idCheck').on('click', function(e) {
		...
		$.get('/cms/module/consultings/apply/checkId.do?homepage_id=' + $('#homepage_id').val() + '&applicant_member_id='+ $('#applicant_member_id').val() + '&search_api_type=' + $('#search_api_type').val(), function(response) {
...
<form:form modelAttribute="consultingApply" id="apply_edit" action="/cms/module/consultings/apply/save.do" method="post" onsubmit="return false;">
...
<table class="type2">
	...
	<tbody>
		...
		<tr>
			<th>신청자 주소</th>
			<td>
				<form:input path="applicant_address" class="text" cssStyle="width:60%"/><button class="btn btn2 findPostCode" keyValue1="#applicant_zipcode" keyValue2="#applicant_address" keyValue3="#age">주소 찾기</button>
			</td>
		</tr>
		<tr>
