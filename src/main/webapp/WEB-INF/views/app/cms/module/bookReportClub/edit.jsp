		...
		buttons: [
			{
				...
				click: function() {
					...
					var option = {
						url : 'save.do',
						type : 'POST',
 						data : $('#bookReportClubEdit').serialize(),
					...
					$('#bookReportClubEdit').ajaxSubmit(option);
				}
			},{
				text: "취소",
				"class": 'btn',
...
<form:form modelAttribute="bookReportClub" id="bookReportClubEdit" action="save.do" enctype="multipart/form-data" >
	...
	<table class="type2">
		...
		<tbody id="board_tbody">
			...
			<tr>
				...
				<td>
					<form:input path="rep_name" cssClass="text" />
				</td>
			</tr>
			<tr>
				<th>휴대폰(제1 연락처)(<span style="color: red;font-weight: bold;">*</span>)</th>
				<td>
			...
			<tr>
				<th>휴대폰(제2 연락처)</th>
				<td>
					<form:input path="user_phone2" cssClass="text" />
					<span>※ 입력 예)010-0000-0000</span>
				</td>
			</tr>
			<tr>
