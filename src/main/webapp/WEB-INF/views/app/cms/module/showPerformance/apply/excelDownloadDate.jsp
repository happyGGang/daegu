...
$(function() {
	...
	var planDateMonth = '${showPerformance.plan_date}';
	for ( var i = 0; i < 15; i ++ ) {
	...
	$('a#excelDownload').on('click', function(event) {
		...
		$('#excelDownloadMonthDate').attr('action','/cms/module/showPerformance/apply/excelDownloadMonth.do?editMode=default').submit();
	});
	...
	$('a#excelDownload2').on('click', function(event) {
		...
		$('#editMode').val("select");
		$('#excelDownloadMonthDate').attr('action','/cms/module/showPerformance/apply/excelDownloadMonth.do?editMode=select').submit();
	});
	
	
});
</script>	
<form:form modelAttribute="showApply" id="excelDownloadMonthDate" action="/cms/module/showPerformance/apply/excelDownloadMonth.do">
<form:hidden path="homepage_id"/>
<form:hidden path="plan_date"/>
<form:hidden path="plan_year1" value="${showApply.plan_year }"/>
<form:hidden path="plan_month1" value="${showApply.plan_month }"/>
...
<div class="table-wrap">
	<table class="type1 center">
			...
			<tr style="height: 50px;">			
				<td>
					<div class="monthYear">
						<form:input path="plan_year1" value="${showApply.plan_year }" disabled="true" style="text-align:center; width:135px; font-weight: bold;"/> -
						<form:input path="plan_month1" value="${showApply.plan_month }" disabled="true" style="text-align:center; width:135px; font-weight: bold;"/>
				    </div>
				</td>
				<td>
