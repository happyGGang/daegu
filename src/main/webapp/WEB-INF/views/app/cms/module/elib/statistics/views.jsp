...
//             $(this).attr({ 'download': filename, 'href': csvData, 'target': '_blank' });
  ...
  $(function() {
    ...
    $('a#csvDownload').on('click', function(e) {
      ...
      var csv = exportTableToCSV(data_table,'구분,공급사,소장자료수,PC 조회수,Android,iOS,(구 스마트폰 조회수),스마트폰 합계,기타(불명) 조회수,소계');
      $('#csv_string').val(csv);
      $('#csv_filename').val('전자도서관_조회수별통계_'+formatDate(new Date())+'.csv');
      $('#csvForm').submit();
    });
...
<form id="csvForm" method="POST" action="index_csv.do">
    ...
    <input type="hidden" id="csv_filename" name="filename" value="전자도서관_조회수별통계.csv">
</form>
<form:form id="elibStatisticsListForm"  modelAttribute="elibStatistics" action="index.do" >
    ...
    <jsp:include page="/WEB-INF/views/app/cms/module/elib/statistics/views_included.jsp" flush="false"/>
</form:form>
