...
<!-- 내집앞도서관 운영장비 등록 form -->
<form:form id="DeviceAdd" modelAttribute="neighborhoodLibraryDevice" method="post" action="save.do" >
	...
	<table class="type2">
		<colgroup>
       	...
       	<tbody>
			<tr>
	         	<th>장비코드</th>
	         	<td><form:input path="device_code" class="text" cssStyle="width:100%"/></td>
	        </tr>
	        <tr>
	         	<th>장비명</th>
