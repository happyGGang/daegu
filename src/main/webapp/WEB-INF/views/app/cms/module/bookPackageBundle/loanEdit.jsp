...
<form:form id="bookPackageLoan" modelAttribute="bookPackageBundle" action="loanSave.do" method="POST">
	<form:hidden path="editMode" id="editMode_u"/>
	<form:hidden path="book_package_bundle_idx" id="book_package_bundle_idx_u"/>
	<form:hidden path="book_package_bundle_loan_idx" id="book_package_bundle_loan_idx_u"/>
	<table class="type2">
		<colgroup>
			<col width="130" />
			<col width="*"/>
