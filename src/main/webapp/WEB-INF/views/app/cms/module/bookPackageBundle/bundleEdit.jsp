...
function addBookPackageDetail() {
	if ( doAjaxPost($('#bookPackageBundle')) ) {
		location.reload();
	}
}
</script>
<form:form id="bookPackageBundle" modelAttribute="bookPackageBundle" action="addBookPackageDetail.do" method="POST">
<form:hidden path="book_package_bundle_detail_idx"/>
		...
		<colgroup>
       	...
       	<tbody>
	        <tr>
	        	...
	        	<td>
	        		${bookPackageBundle.book_package_name}
	        	</td>
	        </tr>
	        <tr>
