...
$(function(){
	$('button').click(function(){
		...
		if (isBook) {
			$('form#dm').attr('action', 'savegm2.do');
		} else if (isMovie) {
			$('form#dm').attr('action', 'savegm3.do');
		} else {
			$('form#dm').attr('action', 'savegm.do');
		}
...
<form id="dm" name="dm" action="savegm.do" method="post" onsubmit="return false;">
<table class="type2">
				<colgroup>
					<col width="150"/>
					<col width="300"/>
