...
public class MessageResolver {
	...
	public String getMessage(Object ob, String key) {
		return msAcc.getMessage(ob.toString().substring(0, ob.toString().indexOf("@"))+"."+key, locale);
	}
	
	public String getMessage(Object ob, String key, Object obj) {
		Object objs[] = new Object[1];
		objs[0] = obj;
		return msAcc.getMessage(ob.toString().substring(0, ob.toString().indexOf("@"))+"."+key, objs, locale);
	}
