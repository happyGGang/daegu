...
public class MediaFactory extends PagingUtils {

	private String homepage_id;
	private int mediaFactory_idx;
	...
	public MediaFactory(String homepage_id, int mediaFactory_idx) {
		setHomepage_id(homepage_id);
		this.mediaFactory_idx = mediaFactory_idx;
	}
	...
	public int getMediaFactory_idx() {
		return mediaFactory_idx;
	}

	public void setMediaFactory_idx(int mediaFactory_idx) {
		this.mediaFactory_idx = mediaFactory_idx;
	}
	
	public int[] getMediaFactory_idx_arr() {
		return mediaFactory_idx_arr;
	}

	public void setMediaFactory_idx_arr(int[] mediaFactory_idx_arr) {
		this.mediaFactory_idx_arr = mediaFactory_idx_arr;
	}
