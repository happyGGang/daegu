...
public class EventReqWorkbook {

	protected WritableWorkbook workbookForm(WritableWorkbook workbook, List<EventReq> eventReqList, List<EventQuestion> eventQuestionList,
		...
		for ( EventReq org : eventReqList ) {
			...
			if ( StringUtils.isNotEmpty(org.getEvent_answer()) ) {
				String[] answerList = org.getEvent_answer().trim().split("\\|");
