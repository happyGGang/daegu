...
public class ShowApply extends PagingUtils {
	...
	private int	age_zero;
	private int	age_one;
	private int	age_two;
	private int	age_three;
	private int age_four;
	...
	private String applicant_agency_tel_2;
	...
	public String getApplicant_agency_tel_1() {
		return applicant_agency_tel_1;
	}

	public void setApplicant_agency_tel_1(String applicant_agency_tel_1) {
		this.applicant_agency_tel_1 = applicant_agency_tel_1;
	}

	public String getApplicant_agency_tel_2() {
		return applicant_agency_tel_2;
	}

	public void setApplicant_agency_tel_2(String applicant_agency_tel_2) {
		this.applicant_agency_tel_2 = applicant_agency_tel_2;
	}

	public String getApplicant_agency_tel_3() {
		return applicant_agency_tel_3;
	}

	public void setApplicant_agency_tel_3(String applicant_agency_tel_3) {
		this.applicant_agency_tel_3 = applicant_agency_tel_3;
	}

	public int getAge_zero() {
		return age_zero;
	}

	public void setAge_zero(int age_zero) {
		this.age_zero = age_zero;
	}

	public int getAge_one() {
		return age_one;
	}

	public void setAge_one(int age_one) {
		this.age_one = age_one;
	}

	public int getAge_two() {
		return age_two;
	}

	public void setAge_two(int age_two) {
		this.age_two = age_two;
	}

	public int getAge_three() {
		return age_three;
	}

	public void setAge_three(int age_three) {
		this.age_three = age_three;
	}

	public int getAge_four() {
		return age_four;
	}

	public void setAge_four(int age_four) {
		this.age_four = age_four;
	}

	public int getAge_five() {
		return age_five;
	}

	public void setAge_five(int age_five) {
		this.age_five = age_five;
	}

	public int getAge_six() {
		return age_six;
	}

	public void setAge_six(int age_six) {
		this.age_six = age_six;
	}

	public int getAge_seven() {
		return age_seven;
	}

	public void setAge_seven(int age_seven) {
		this.age_seven = age_seven;
	}
	...
	public String getApplicant_agency_name() {
		return applicant_agency_name;
	}

	public void setApplicant_agency_name(String applicant_agency_name) {
		this.applicant_agency_name = applicant_agency_name;
	}

	public String getApplicant_agency_tel() {
		return applicant_agency_tel;
	}

	public void setApplicant_agency_tel(String applicant_agency_tel) {
		this.applicant_agency_tel = applicant_agency_tel;
	}

	public String getApplicant_agency_address() {
		return applicant_agency_address;
	}

	public void setApplicant_agency_address(String applicant_agency_address) {
		this.applicant_agency_address = applicant_agency_address;
	}
