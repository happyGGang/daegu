...
public class AddressBook extends PagingUtils {
	...
	private String las_user_id;  //일루스USER_ID
	private String las_user_seq;  //일루스USER_SEQ
	private String las_web_id;  //일루스WEB_ID
	...
	public void setLas_web_id(String las_web_id) {
		this.las_web_id = las_web_id;
	}
