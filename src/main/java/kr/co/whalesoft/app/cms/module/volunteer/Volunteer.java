...
public class Volunteer extends PagingUtils {

	private String homepage_id;
	private int volunteer_idx;
	private int[] volunteer_idx_arr;
	...
	public Volunteer(String homepage_id, int volunteer_idx) {
		setHomepage_id(homepage_id);
		this.volunteer_idx = volunteer_idx;
	}
	...
	public int getVolunteer_idx() {
		return volunteer_idx;
	}

	public void setVolunteer_idx(int volunteer_idx) {
		this.volunteer_idx = volunteer_idx;
	}

	public int[] getVolunteer_idx_arr() {
		return volunteer_idx_arr;
	}

	public void setVolunteer_idx_arr(int[] volunteer_idx_arr) {
		this.volunteer_idx_arr = volunteer_idx_arr;
	}
