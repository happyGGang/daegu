package kr.go.gbelib.app.cms.module.newelib.book;
...
import kr.go.gbelib.app.cms.module.newelib.category.ElibCategoryService;
import kr.go.gbelib.app.cms.module.newelib.code.ElibCode;
import kr.go.gbelib.app.cms.module.newelib.code.ElibCodeService;
import kr.go.gbelib.app.cms.module.newelib.lending.LendingAutoReturnServiceNew;
import kr.go.gbelib.app.cms.module.newelib.member.ElibMember;
import kr.go.gbelib.app.cms.module.newelib.member.ElibMemberService;
import kr.go.gbelib.app.common.api.MemberAPI;

@Controller(value = "bookControllerNew")
public class BookController extends BaseController {
	
	private final String basePath = "/cms/module/newelib/book/";
	...
	@Autowired
	private LendingAutoReturnServiceNew lendingAutoReturnServiceNew;
	
	@Autowired
	private ElibMemberService elibMemberService;
	
	@RequestMapping(value = {"/cms/module/newelib/book/{type}/index.*"})
	...
	@RequestMapping(value = {"/cms/module/newelib/book/{type}/edit.*"})
	...
	@RequestMapping(value = {"/cms/module/newelib/book/{type}/save.*"}, method = RequestMethod.POST)
...
//			}
	...
	@RequestMapping(value = {"/cms/module/newelib/book/{type}/excelDownload.*"}, method = RequestMethod.POST)
	...
	@RequestMapping(value = {"/cms/module/newelib/book/{type}/csvDownload.*"}, method = RequestMethod.POST)
	...
	@RequestMapping(value = {"/cms/module/newelib/book/upload_index.*"})
	...
	@RequestMapping(value = {"/cms/module/newelib/book/result.*"})
...
//		out.add("자료없음 ID: " + result.get("notExistIds"));
	...
	@RequestMapping(value = {"/cms/module/newelib/book/approve.*"}, method = RequestMethod.POST)
	...
	@RequestMapping(value = {"/cms/module/newelib/book/approve_all.*"}, method = RequestMethod.POST)
	...
	@RequestMapping(value = {"/cms/module/newelib/book/auto_return.*"})
	...
	@RequestMapping(value = {"/cms/module/newelib/book/auto_update_lendable_dt.*"})
...
//		member.setCheck_certify_data(elibMember.getMember_id());
	...
	@RequestMapping(value = {"/cms/module/newelib/book/fill_in_members.*"})
