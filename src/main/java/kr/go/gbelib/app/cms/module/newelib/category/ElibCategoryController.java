...
@Controller(value = "elibCategoryControllerNew")
@RequestMapping(value = {"/cms/module/newelib/category/{type}"})
public class ElibCategoryController extends BaseController {

	private final String basePath = "/cms/module/newelib/category/";
