...
public class CheckInOutSurveyReqWorkbook {

	protected WritableWorkbook workbookForm(WritableWorkbook workbook, List<CheckInOutSurveyReq> checkInOutSurveyReqList, List<CheckInOutSurveyQuestion> checkInOutSurveyQuestionList,
		...
		int row = 1;
		/*for ( CheckInOutSurveyReq org : checkInOutSurveyReqList) {
