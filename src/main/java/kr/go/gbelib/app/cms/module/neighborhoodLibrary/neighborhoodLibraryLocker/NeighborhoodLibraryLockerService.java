 ...
 */
@Service
public class NeighborhoodLibraryLockerService extends BaseService {
	
	@Autowired
	private NeighborhoodLibraryLockerDao dao;
	
	@Transactional
	public int addNeighborhoodLibraryLocker(NeighborhoodLibraryLocker neighborhoodLibraryLocker) {
			if(dao.addNeighborhoodLibraryLocker(neighborhoodLibraryLocker) > 0) {
				NeighborhoodLibraryLocker thisLocker = dao.getNeighborhoodLibraryLockerOne(neighborhoodLibraryLocker); 
	...
	public NeighborhoodLibraryLocker getNeighborhoodLibraryLockerOne(NeighborhoodLibraryLocker neighborhoodLibraryLocker) {
		return dao.getNeighborhoodLibraryLockerOne(neighborhoodLibraryLocker);
	}

	public int getNeighborhoodLibraryLockerCount(NeighborhoodLibraryLocker neighborhoodLibraryLocker) {
		return dao.getNeighborhoodLibraryLockerCount(neighborhoodLibraryLocker);
	}

	public List<NeighborhoodLibraryLocker> getNeighborhoodLibraryLockerEachOneList(NeighborhoodLibraryLocker neighborhoodLibraryLocker) {
		return dao.getNeighborhoodLibraryLockerEachOneList(neighborhoodLibraryLocker);
	}

	public int modifyNeighborhoodLibraryLocker(NeighborhoodLibraryLocker neighborhoodLibraryLocker) {
		return dao.modifyNeighborhoodLibraryLocker(neighborhoodLibraryLocker);
		
	}

	public int getNeighborhoodLibraryLockerEachOneListCount(NeighborhoodLibraryLocker neighborhoodLibraryLocker) {
