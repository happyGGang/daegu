...
public class TeachService extends BaseService {
	...
	public List<Teach> getTeachListForActiveUser(Teach teach) {
		teach.setSearchCate1(numbersOnly(teach.getSearchCate1()));
		teach.setSearchCate2(numbersOnly(teach.getSearchCate2()));
		teach.setSearchCate3(numbersOnly(teach.getSearchCate3()));
		teach.setGroup_idx_list(numbersOnly(teach.getGroup_idx_list()));

		List<Teach> teachListForUser = dao.getTeachListForActiveUser(teach);
	...
	public int getTeachListForAllSearchCultureCountByStartDate(Teach teach) {
		...
		return dao.getTeachListForAllSearchCultureCountByStartDate(teach);
	}
	...
	public List<Teach> getTeachListForAllSearchCultureByStartDate(Teach teach) {
		...
		List<Teach> list = dao.getTeachListForAllSearchCultureByStartDate(teach);
	...
	public List<Teach> getCultureViewList(Teach teach) {
		return dao.getCultureViewList(teach);
	}
