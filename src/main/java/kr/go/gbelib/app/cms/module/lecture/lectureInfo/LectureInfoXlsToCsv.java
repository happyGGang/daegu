...
public class LectureInfoXlsToCsv {

	public LectureInfoXlsToCsv(List<LectureInfo> lectureInfoList, String fileName, Homepage homepage, HttpServletRequest request, HttpServletResponse response) {
		try {
			OutputStream out = response.getOutputStream();
			WritableWorkbook workbook = Workbook.createWorkbook(out);
			workbook = new LectureInfoWorkbook().workbookForm(workbook, lectureInfoList, homepage, request, response);
			response.reset();
