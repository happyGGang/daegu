...
public class CourseInfoXlsToCsv {

	public CourseInfoXlsToCsv(List<CourseInfo> courseInfoList, String fileName, Homepage homepage, HttpServletRequest request, HttpServletResponse response) {
		try {
			OutputStream out = response.getOutputStream();
			WritableWorkbook workbook = Workbook.createWorkbook(out);
			workbook = new CourseInfoWorkbook().workbookForm(workbook, courseInfoList, homepage, request, response);
			response.reset();
