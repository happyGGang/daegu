...
public class PrivateLibSearchAPI {

	protected final static Logger log = LoggerFactory.getLogger(PrivateLibSearchAPI.class);
	...
	public static String getBookInterestLoanList(Lending lending) {
		...
		result = CommonAPI.sendPrivateKCMS("getinterestloancnt", param);
	...
	public static Map<String, Object> getBookNormal(LibrarySearch librarySearch) {
		...
		result = CommonAPI.sendPrivateKCMS("booksearch", param);
	...
	public static Map<String, Object> getSerialNormal(LibrarySearch librarySearch) {
		...
		result = CommonAPI.sendPrivateKCMS("serialsearch", param);
	...
	public static Map<String, Object> getSerialSpecies(LibrarySearch librarySearch) {
		...
		result = CommonAPI.sendPrivateKCMS("serialdetail", param);
	...
	public static Map<String, Object> getNonBookNormal(LibrarySearch librarySearch) {
		...
		result = CommonAPI.sendPrivateKCMS("nonbooksearch", param);
	...
	public static Map<String, Object> getBookLoanList(String userkey) {
		...
		return CommonAPI.sendPrivateKCMS("bookloanlist", param);
	}
...
//		param.put("display", rowCount);
	...
	public static ApiResponse renewLoan(LibrarySearch librarySearch) {
		...
		Map<String, Object> sendKCMS = CommonAPI.sendPrivateKCMS("bookreturndelay", param);
	...
	public static Map<String, Object> getBookLoanHistory(LibrarySearch librarySearch) {
		...
		return CommonAPI.sendPrivateKCMS("bookreturnlist", param);
	}
	...
	public static Map<String, Object> getBookFurnishList(LibrarySearch librarySearch) {
		...
		return CommonAPI.sendPrivateKCMS("bookfurnishlist", param);
	...
	public static Map<String, Object> getAllBookFurnishList(LibrarySearch librarySearch) {
		...
		return CommonAPI.sendPrivateKCMS("allbookfurnishlist", param);
	}
	...
	public static ApiResponse hopeUserCheck(String userkey, String isbn, String manage_code) {
		...
		Map<String, Object> sendKCMS = CommonAPI.sendPrivateKCMS("bookfurnishrequestcheck", param);
	...
	public static ApiResponse reqHope(LibrarySearch librarySearch, Member member) {
		...
		Map<String, Object> sendKCMS = CommonAPI.sendPrivateKCMS("bookfurnishrequest", param);
	...
	public static ApiResponse modHope(LibrarySearch librarySearch) {
		...
		Map<String, Object> sendKCMS = CommonAPI.sendPrivateKCMS("bookfurnishcancel", param);
	...
	public static Map<String, Object> getReserveList(String userkey) {
		...
		return CommonAPI.sendPrivateKCMS("bookreservelist", param);
	}
	...
	public static ApiResponse cancelResve(LibrarySearch librarySearch) {
		...
		Map<String, Object> sendKCMS = CommonAPI.sendPrivateKCMS("bookreservecancel", param);
	...
	public static ApiResponse reqResve(LibrarySearch librarySearch) {
		...
		Map<String, Object> sendKCMS = CommonAPI.sendPrivateKCMS("bookreserve", param);
	...
	public static Map<String, Object> getUserreCommBooks(LibrarySearch librarySearch) {
		...
		result = CommonAPI.sendPrivateKCMS("getuseranalyzedbooks", param);
	...
	public static Map<String, Object> getBestBookList(LibrarySearch librarySearch) {
		...
		result = CommonAPI.sendPrivateKCMS("bookloanbest", param);
...
//		}
		...
		result = CommonAPI.sendPrivateKCMS("newbooklist", param);
...
//		}
	...
	public static Map<String, Object> getBookInfo(LibrarySearch librarySearch) {
		...
		result = CommonAPI.sendPrivateKCMS("getbookinfo", param);
	...
	public static Map<String, Object> getHotTrendWordList(String manage_code) {
		Map<String, Object> param = new HashMap<String, Object>();
		param.put("manage_code", manage_code);
		return CommonAPI.sendPrivateKCMS("searchwordbest", param);
	}
	...
	public static Map<String, Object> getLibSettingInfoView(String manage_code, String option, String offer_yn, String loan_yn, String return_yn, String group_code) {
		...
		return CommonAPI.sendPrivateKCMS("libsettinginfoview", param);
	}
	...
	public static Map<String, Object> getBookAndNonbookDetail(LibrarySearch librarySearch) {
		...
		result = CommonAPI.sendPrivateKCMS("bookandnonbooksearch", param);
	...
	public static Map<String, Object> getSubLocaInfo(String class_code, String manage_code) {
		...
		param.put("manage_code", manage_code);
		return CommonAPI.sendPrivateKCMS("getcodeinfo", param);
	}
	...
	public static ApiResponse nightloanreserve(LibrarySearch librarySearch) {
		...
		Map<String, Object> sendKCMS = CommonAPI.sendPrivateKCMS("nightloanreserve", param);
	...
	public static Map<String, Object> getNightLoanReserveCnt(LibrarySearch librarySearch, String type) {
		...
		return CommonAPI.sendPrivateKCMS("getnightloanreservecnt", param);
	}
	...
	public static ApiResponse unmannedloanreserve(LibrarySearch librarySearch) {
		...
		Map<String, Object> sendKCMS = CommonAPI.sendPrivateKCMS("unmannedloanreserve", param);
	...
	public static Map<String, Object> getUnmannedLoanReserveCnt(LibrarySearch librarySearch, String type) {
		...
		return CommonAPI.sendPrivateKCMS("getunmannedloanreservecnt", param);
	}
	...
	public static Map<String, Object> getUnmannedLoanReserveList(LibrarySearch librarySearch, String workno) {
		...
		return CommonAPI.sendPrivateKCMS("getunmannedloanreservelist", param);
	}
	...
	public static Map<String, Object> getCheckHoliday(LibrarySearch librarySearch) {
		...
		result = CommonAPI.sendPrivateKCMS("checkHoliday", param);
	...
	public static Map<String, Object> getMarc(String regno) {
		...
		return CommonAPI.sendPrivateMARC("getmarc", param);
	}
	...
	public static ApiResponse lillRequestCheck(LibrarySearch librarySearch) {
		...
		Map<String, Object> sendKCMS = CommonAPI.sendPrivateKCMS("lillRequestCheck", param);
	...
	public static ApiResponse lillRequest(LibrarySearch librarySearch) {
		...
		Map<String, Object> sendKCMS = CommonAPI.sendPrivateKCMS("lillRequest", param);
	...
	public static ApiResponse lillRequestCancel(LibrarySearch librarySearch) {
		...
		Map<String, Object> sendKCMS = CommonAPI.sendPrivateKCMS("lillRequestCancel", param);
	...
	public static Map<String, Object> lillRequestList(LibrarySearch librarySearch, String option) {
		...
		return CommonAPI.sendPrivateKCMS("lillRequestList", param);
...
//		return CommonAPI.sendALADIN(param, "detail");
	...
	public static ApiResponse bookreserveUpdateStatus(LibrarySearch librarySearch) {
		...
		Map<String, Object> sendKCMS = CommonAPI.sendPrivateKCMS("bookreserveUpdateStatus", param);
	...
	public static ApiResponse unmannedloan(LibrarySearch librarySearch, String ip) {
		...
		Map<String, Object> sendKCMS = CommonAPI.sendPrivateKCMS("unmannedloan", param);
	...
	public static ApiResponse unmannedreturn(LibrarySearch librarySearch, String ip) {
		...
		Map<String, Object> sendKCMS = CommonAPI.sendPrivateKCMS("unmannedreturn", param);
	...
	public static ApiResponse unmannedloancheck(LibrarySearch librarySearch) {
		...
		Map<String, Object> sendKCMS = CommonAPI.sendPrivateKCMS("unmannedloancheck", param);
	...
	public static String getUserkey(LibrarySearch librarySearch) {
		...
		Map<String, Object> userData = CommonAPI.sendPrivateKCMS("getuserkey", param);
