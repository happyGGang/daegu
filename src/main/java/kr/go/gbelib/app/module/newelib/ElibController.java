package kr.go.gbelib.app.module.newelib;
...
import kr.go.gbelib.app.cms.module.newelib.accessIp.ElibAccessIp;
import kr.go.gbelib.app.cms.module.newelib.accessIp.ElibAccessIpService;
import kr.go.gbelib.app.cms.module.newelib.api.APIService;
import kr.go.gbelib.app.cms.module.newelib.api.ElibException;
import kr.go.gbelib.app.cms.module.newelib.best.BestService;
...
import kr.go.gbelib.app.cms.module.newelib.comment.Comment;
import kr.go.gbelib.app.cms.module.newelib.comment.CommentService;
...
@Controller(value = "elibControllerNew")
@RequestMapping(value = {"/newelib/module/newelib"})
public class ElibController extends BaseController {

	private String basePath = "/homepage/%s/module/newelib/";
	...
	public String lending_index(Model model, Lending lending, HttpServletRequest request, HttpServletResponse response) {
		...
		lending.setBefore_url(String.format("/%s/module/newelib/lending/index.do?menu_idx=%s&menu=%s", homepage.getContext_path(), lending.getMenu_idx(), lending.getMenu()));
